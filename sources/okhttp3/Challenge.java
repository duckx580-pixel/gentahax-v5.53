...
public final class Challenge {
    ...
    public final Map<String, String> m5235deprecated_authParams() {
        return this.authParams;
    }
    ...
    public final String m5237deprecated_realm() {
        return realm();
    }

    @Deprecated(level = DeprecationLevel.ERROR, message = "moved to val", replaceWith = @ReplaceWith(expression = nb.M, imports = {}))
    /* JADX INFO: renamed from: -deprecated_charset, reason: not valid java name */
    public final Charset m5236deprecated_charset() {
        return charset();
    }
