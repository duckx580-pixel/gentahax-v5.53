...
public final class HttpUrl {
    ...
    public final String m5269deprecated_encodedUsername() {
    ...
    public final String m5265deprecated_encodedPassword() {
        ...
        */
        ...
        public final Builder parse$okhttp(HttpUrl base, String input) {
            ...
            if (iSchemeDelimiterOffset != -1) {
                ...
                throw new IllegalArgumentException(Intrinsics.stringPlus("Expected URL scheme 'http' or 'https' but no scheme was found for ", input2.length() > 6 ? Intrinsics.stringPlus(StringsKt.take(input2, 6), "...") : input2));
            }
    ...
    public static final class Companion {
        ...
        public final List<String> toQueryNamesAndValues$okhttp(String str) {
            ...
            while (i <= str.length()) {
                ...
                int iIndexOf$default2 = StringsKt.indexOf$default((CharSequence) str2, nb.T, i, false, 4, (Object) null);
        ...
        public final HttpUrl m5283deprecated_get(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        public final HttpUrl m5286deprecated_parse(String url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return parse(url);
        }
        ...
        @Deprecated(level = DeprecationLevel.ERROR, message = "moved to extension function", replaceWith = @ReplaceWith(expression = "url.toHttpUrlOrNull()", imports = {"okhttp3.HttpUrl.Companion.toHttpUrlOrNull"}))
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m5285deprecated_get(URL url) {
            Intrinsics.checkNotNullParameter(url, "url");
            return get(url);
        }
        ...
        /* JADX INFO: renamed from: -deprecated_get, reason: not valid java name */
        public final HttpUrl m5284deprecated_get(URI uri) {
