...
public final class MediaType {
    ...
    public final Charset charset(Charset defaultValue) {
        String strParameter = parameter(nb.M);
    ...
    public static final class Companion {
        ...
        public final MediaType m5289deprecated_get(String mediaType) {
        ...
        public final MediaType m5290deprecated_parse(String mediaType) {
            Intrinsics.checkNotNullParameter(mediaType, "mediaType");
