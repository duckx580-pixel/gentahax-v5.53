...
public final class HexExtensionsKt {
    ...
    */
    ...
    public static final int formattedStringLength(int i, int i2, int i3, int i4, int i5, int i6, int i7) {
        ...
        throw new IllegalArgumentException("The resulting string length is too big: " + ((Object) ULong.m3823toStringimpl(ULong.m3777constructorimpl(j))));
    }
    ...
    private static final byte[] hexToByteArray(String str, int i, int i2, HexFormat hexFormat) {
        ...
        int i4 = parsedByteArrayMaxSize(i2 - iCheckContainsAt, bytesPerLine, bytesPerGroup, groupSeparator.length(), byteSeparator.length(), bytePrefix.length(), byteSuffix.length());
        ...
        while (iCheckContainsAt < i2) {
            ...
            bArr[i5] = (byte) ((decimalFromHexDigitAt(str, iCheckContainsAt2) << 4) | decimalFromHexDigitAt(str, iCheckContainsAt2 + 1));
    ...
    private static final int checkContainsAt(String str, String str2, int i, int i2, String str3) {
        ...
        StringBuilder sbAppend = new StringBuilder("Expected ").append(str3).append(" \"").append(str5).append("\" at index ").append(i3).append(", but was ");
