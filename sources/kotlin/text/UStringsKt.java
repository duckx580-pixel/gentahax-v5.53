...
public final class UStringsKt {
    ...
    public static final String m4916toStringLxnNnR4(byte b, int i) {
    ...
    public static final String m4918toStringolVBNx4(short s, int i) {
    ...
    public static final String m4917toStringV7xB4Y4(int i, int i2) {
    ...
    public static final String m4915toStringJSWoG40(long j, int i) {
    ...
    public static final UByte toUByteOrNull(String str, int i) {
        ...
        if (Integer.compareUnsigned(data, UInt.m3698constructorimpl(255)) > 0) {
            return null;
        }
        return UByte.m3615boximpl(UByte.m3621constructorimpl((byte) data));
    }
    ...
    public static final UShort toUShortOrNull(String str, int i) {
        ...
        int data = uIntOrNull.getData();
        if (Integer.compareUnsigned(data, UInt.m3698constructorimpl(65535)) > 0) {
            return null;
        }
        return UShort.m3878boximpl(UShort.m3884constructorimpl((short) data));
    }
    ...
    public static final UInt toUIntOrNull(String str, int i) {
        ...
        int iM3698constructorimpl = UInt.m3698constructorimpl(i);
        ...
        while (i2 < length) {
            ...
            if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                if (iDivideUnsigned == 119304647) {
                    iDivideUnsigned = Integer.divideUnsigned(-1, iM3698constructorimpl);
                    if (Integer.compareUnsigned(i3, iDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            int iM3698constructorimpl2 = UInt.m3698constructorimpl(i3 * iM3698constructorimpl);
            int iM3698constructorimpl3 = UInt.m3698constructorimpl(UInt.m3698constructorimpl(iDigitOf) + iM3698constructorimpl2);
            if (Integer.compareUnsigned(iM3698constructorimpl3, iM3698constructorimpl2) < 0) {
                return null;
            }
            i2++;
            i3 = iM3698constructorimpl3;
        }
        return UInt.m3692boximpl(i3);
    }
    ...
    public static final ULong toULongOrNull(String str, int i) {
        ...
        long jM3777constructorimpl = ULong.m3777constructorimpl(i);
        long j = 0;
        ...
        while (i2 < length) {
            ...
            if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                if (jDivideUnsigned == 512409557603043100L) {
                    jDivideUnsigned = Long.divideUnsigned(-1L, jM3777constructorimpl);
                    if (Long.compareUnsigned(j, jDivideUnsigned) > 0) {
                    }
                }
                return null;
            }
            long jM3777constructorimpl2 = ULong.m3777constructorimpl(j * jM3777constructorimpl);
            long jM3777constructorimpl3 = ULong.m3777constructorimpl(ULong.m3777constructorimpl(((long) UInt.m3698constructorimpl(iDigitOf)) & 4294967295L) + jM3777constructorimpl2);
            if (Long.compareUnsigned(jM3777constructorimpl3, jM3777constructorimpl2) < 0) {
                return null;
            }
            i2++;
            j = jM3777constructorimpl3;
        }
        return ULong.m3771boximpl(j);
    }
}
