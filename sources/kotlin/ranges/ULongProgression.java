...
public class ULongProgression implements Iterable<ULong>, KMappedMarker {
    ...
    private ULongProgression(long j, long j2, long j3) {
        ...
        this.first = j;
        this.last = UProgressionUtilKt.m4811getProgressionLastElement7ftBX0g(j, j2, j3);
        this.step = j3;
    }
    ...
    public int hashCode() {
        ...
        long j = this.first;
        int iM3777constructorimpl = ((int) ULong.m3777constructorimpl(j ^ ULong.m3777constructorimpl(j >>> 32))) * 31;
        long j2 = this.last;
        int iM3777constructorimpl2 = (iM3777constructorimpl + ((int) ULong.m3777constructorimpl(j2 ^ ULong.m3777constructorimpl(j2 >>> 32)))) * 31;
        long j3 = this.step;
        return iM3777constructorimpl2 + ((int) ((j3 >>> 32) ^ j3));
    }
    ...
    public String toString() {
        ...
        long j;
        if (this.step > 0) {
            sbAppend = new StringBuilder().append((Object) ULong.m3823toStringimpl(this.first)).append("..").append((Object) ULong.m3823toStringimpl(this.last)).append(" step ");
            j = this.step;
        } else {
            sbAppend = new StringBuilder().append((Object) ULong.m3823toStringimpl(this.first)).append(" downTo ").append((Object) ULong.m3823toStringimpl(this.last)).append(" step ");
            j = -this.step;
        }
    ...
    public static final class Companion {
        ...
        public final ULongProgression m4837fromClosedRange7ftBX0g(long rangeStart, long rangeEnd, long step) {
