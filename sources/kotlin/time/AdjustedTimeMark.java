...
final class AdjustedTimeMark implements TimeMark {
    ...
    public TimeMark mo4920minusLRDsOJo(long j) {
        return TimeMark.DefaultImpls.m5066minusLRDsOJo(this, j);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: elapsedNow-UwyO8pc */
    public long mo4919elapsedNowUwyO8pc() {
        return Duration.m4964minusLRDsOJo(this.mark.mo4919elapsedNowUwyO8pc(), this.adjustment);
    }

    @Override // kotlin.time.TimeMark
    /* JADX INFO: renamed from: plus-LRDsOJo */
    public TimeMark mo4922plusLRDsOJo(long duration) {
        return new AdjustedTimeMark(this.mark, Duration.m4965plusLRDsOJo(this.adjustment, duration), null);
    }
}
