...
public final class DurationKt {
    ...
    private static final long m5056timesmvk6XK0(int i, long j) {
        return Duration.m4967timesUwyO8pc(j, i);
    }

    /* JADX INFO: renamed from: times-kIfJnKk, reason: not valid java name */
    private static final long m5055timeskIfJnKk(double d, long j) {
        return Duration.m4966timesUwyO8pc(j, d);
    }
    ...
    public static final long parseDuration(String str, boolean z) {
        ...
        long jM5032getZEROUwyO8pc = Duration.INSTANCE.m5032getZEROUwyO8pc();
        ...
        if (str.charAt(length2) == 'P') {
            ...
            while (i3 < length) {
                if (str.charAt(i3) != 'T') {
                    ...
                    if (durationUnitDurationUnitByIsoChar == DurationUnit.SECONDS && iIndexOf$default > 0) {
                        ...
                        long jM4965plusLRDsOJo = Duration.m4965plusLRDsOJo(jM5032getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring2), durationUnitDurationUnitByIsoChar));
                        Intrinsics.checkNotNull(strSubstring, "null cannot be cast to non-null type java.lang.String");
                        String strSubstring3 = strSubstring.substring(iIndexOf$default);
                        Intrinsics.checkNotNullExpressionValue(strSubstring3, "substring(...)");
                        jM5032getZEROUwyO8pc = Duration.m4965plusLRDsOJo(jM4965plusLRDsOJo, toDuration(Double.parseDouble(strSubstring3), durationUnitDurationUnitByIsoChar));
                    } else {
                        jM5032getZEROUwyO8pc = Duration.m4965plusLRDsOJo(jM5032getZEROUwyO8pc, toDuration(parseOverLongIsoComponent(strSubstring), durationUnitDurationUnitByIsoChar));
                    }
                    obj2 = obj;
            ...
            if (StringsKt.regionMatches(str, length2, "Infinity", 0, iMax, true)) {
                jM5032getZEROUwyO8pc = Duration.INSTANCE.m5030getINFINITEUwyO8pc();
            } else {
                boolean z6 = !z3;
                ...
                while (length2 < i) {
                    ...
                    while (i6 < str.length()) {
                        ...
                        if (!new CharRange('0', c3).contains(cCharAt4) && cCharAt4 != '.') {
                            break;
                        }
                        i6++;
                    }
                    ...
                    if (iIndexOf$default2 > 0) {
                        ...
                        long jM4965plusLRDsOJo2 = Duration.m4965plusLRDsOJo(jM5032getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring6), durationUnitDurationUnitByShortName));
                        Intrinsics.checkNotNull(strSubstring4, "null cannot be cast to non-null type java.lang.String");
                        ...
                        jM5032getZEROUwyO8pc = Duration.m4965plusLRDsOJo(jM4965plusLRDsOJo2, toDuration(Double.parseDouble(strSubstring7), durationUnitDurationUnitByShortName));
                        if (length2 < i) {
                            throw new IllegalArgumentException("Fractional component must be last");
                        }
                    } else {
                        jM5032getZEROUwyO8pc = Duration.m4965plusLRDsOJo(jM5032getZEROUwyO8pc, toDuration(Long.parseLong(strSubstring4), durationUnitDurationUnitByShortName));
                    }
        ...
        return z4 ? Duration.m4982unaryMinusUwyO8pc(jM5032getZEROUwyO8pc) : jM5032getZEROUwyO8pc;
    }
    ...
    public static final long durationOfNanos(long j) {
        return Duration.m4929constructorimpl(j << 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOfMillis(long j) {
        return Duration.m4929constructorimpl((j << 1) + 1);
    }

    /* JADX INFO: Access modifiers changed from: private */
    public static final long durationOf(long j, int i) {
        return Duration.m4929constructorimpl((j << 1) + ((long) i));
    }
