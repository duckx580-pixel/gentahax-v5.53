...
public final class UnsignedKt {
    ...
    public static final int m3954uintDivideJ1ME1BU(int i, int i2) {
        return UInt.m3698constructorimpl((int) ((((long) i) & 4294967295L) / (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: uintRemainder-J1ME1BU, reason: not valid java name */
    public static final int m3955uintRemainderJ1ME1BU(int i, int i2) {
        return UInt.m3698constructorimpl((int) ((((long) i) & 4294967295L) % (((long) i2) & 4294967295L)));
    }

    /* JADX INFO: renamed from: ulongDivide-eb3DHEI, reason: not valid java name */
    public static final long m3956ulongDivideeb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? ULong.m3777constructorimpl(0L) : ULong.m3777constructorimpl(1L);
        }
        if (j >= 0) {
            return ULong.m3777constructorimpl(j / j2);
        }
        long j3 = ((j >>> 1) / j2) << 1;
        return ULong.m3777constructorimpl(j3 + ((long) (Long.compareUnsigned(ULong.m3777constructorimpl(j - (j3 * j2)), ULong.m3777constructorimpl(j2)) < 0 ? 0 : 1)));
    }

    /* JADX INFO: renamed from: ulongRemainder-eb3DHEI, reason: not valid java name */
    public static final long m3957ulongRemaindereb3DHEI(long j, long j2) {
        if (j2 < 0) {
            return Long.compareUnsigned(j, j2) < 0 ? j : ULong.m3777constructorimpl(j - j2);
        }
        if (j >= 0) {
            return ULong.m3777constructorimpl(j % j2);
        }
        long j3 = j - ((((j >>> 1) / j2) << 1) * j2);
        if (Long.compareUnsigned(ULong.m3777constructorimpl(j3), ULong.m3777constructorimpl(j2)) < 0) {
            j2 = 0;
        }
        return ULong.m3777constructorimpl(j3 - j2);
    }
    ...
    public static final int doubleToUInt(double d) {
        ...
        if (d <= 2.147483647E9d) {
            return UInt.m3698constructorimpl((int) d);
        }
        return UInt.m3698constructorimpl(UInt.m3698constructorimpl((int) (d - ((double) Integer.MAX_VALUE))) + UInt.m3698constructorimpl(Integer.MAX_VALUE));
    }
    ...
    public static final long doubleToULong(double d) {
        ...
        if (d < 9.223372036854776E18d) {
            return ULong.m3777constructorimpl((long) d);
        }
        return ULong.m3777constructorimpl(ULong.m3777constructorimpl((long) (d - 9.223372036854776E18d)) - Long.MIN_VALUE);
    }
