...
public class FirebaseMessaging {
    ...
    FirebaseMessaging(FirebaseApp firebaseApp, FirebaseInstanceIdInternal firebaseInstanceIdInternal, Provider<TransportFactory> provider, Subscriber subscriber, Metadata metadata, GmsRpc gmsRpc, Executor executor, Executor executor2, Executor executor3) {
        ...
        if (firebaseInstanceIdInternal != null) {
            firebaseInstanceIdInternal.addNewTokenListener(new FirebaseInstanceIdInternal.NewTokenListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda3
                ...
                public final void onNewToken(String str) {
                    this.f$0.m296lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(str);
                }
            });
        }
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda4
            ...
            public final void run() {
                this.f$0.m297lambda$new$2$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
        ...
        taskCreateInstance.addOnSuccessListener(executor2, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda5
            ...
            public final void onSuccess(Object obj) {
                this.f$0.m298lambda$new$3$comgooglefirebasemessagingFirebaseMessaging((TopicsSubscriber) obj);
            }
        });
        executor2.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m299lambda$new$4$comgooglefirebasemessagingFirebaseMessaging();
            }
        });
    }

    /* JADX INFO: renamed from: lambda$new$2$com-google-firebase-messaging-FirebaseMessaging, reason: not valid java name */
    /* synthetic */ void m297lambda$new$2$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    /* synthetic */ void m298lambda$new$3$comgooglefirebasemessagingFirebaseMessaging(TopicsSubscriber topicsSubscriber) {
        if (isAutoInitEnabled()) {
    ...
    public void m299lambda$new$4$comgooglefirebasemessagingFirebaseMessaging() {
    ...
    private void handleProxiedNotificationData() {
        this.gmsRpc.getProxyNotificationData().addOnSuccessListener(this.initExecutor, new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda12
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                this.f$0.m295lambda$handleProxiedNotificationData$5$comgooglefirebasemessagingFirebaseMessaging((CloudMessage) obj);
            }
        });
    }
    ...
    /* synthetic */ void m295lambda$handleProxiedNotificationData$5$comgooglefirebasemessagingFirebaseMessaging(CloudMessage cloudMessage) {
    ...
    public Task<Void> setNotificationDelegationEnabled(boolean z) {
        return ProxyNotificationInitializer.setEnableProxyNotification(this.initExecutor, this.context, z).addOnSuccessListener(new CredentialManager$$ExternalSyntheticLambda0(), new OnSuccessListener() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda10
            @Override // com.google.android.gms.tasks.OnSuccessListener
            public final void onSuccess(Object obj) {
                this.f$0.m300lambda$setNotificationDelegationEnabled$6$comgooglefirebasemessagingFirebaseMessaging((Void) obj);
            }
        });
    }
    ...
    /* synthetic */ void m300lambda$setNotificationDelegationEnabled$6$comgooglefirebasemessagingFirebaseMessaging(Void r3) {
        ProxyNotificationPreferences.setProxyRetention(this.context, this.gmsRpc, shouldRetainProxyNotifications());
    }
    ...
    public Task<String> getToken() {
        ...
        this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m294lambda$getToken$7$comgooglefirebasemessagingFirebaseMessaging(taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m294lambda$getToken$7$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    public Task<Void> deleteToken() {
        if (this.iid != null) {
            ...
            this.initExecutor.execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda1
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m292lambda$deleteToken$8$comgooglefirebasemessagingFirebaseMessaging(taskCompletionSource);
                }
            });
            return taskCompletionSource.getTask();
        }
        ...
        FcmExecutors.newNetworkIOExecutor().execute(new Runnable() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m293lambda$deleteToken$9$comgooglefirebasemessagingFirebaseMessaging(taskCompletionSource2);
            }
        });
    ...
    /* synthetic */ void m292lambda$deleteToken$8$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
    ...
    /* synthetic */ void m293lambda$deleteToken$9$comgooglefirebasemessagingFirebaseMessaging(TaskCompletionSource taskCompletionSource) {
        try {
        ...
        try {
            return (String) Tasks.await(this.requestDeduplicator.getOrStartGetTokenRequest(defaultSenderId, new RequestDeduplicator.GetTokenRequest() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda14
                ...
                public final Task start() {
                    return this.f$0.m291lambda$blockingGetToken$14$comgooglefirebasemessagingFirebaseMessaging(defaultSenderId, tokenWithoutTriggeringSync);
                }
            }));
    ...
    /* synthetic */ Task m291lambda$blockingGetToken$14$comgooglefirebasemessagingFirebaseMessaging(final String str, final Store.Token token) {
        return this.gmsRpc.getToken().onSuccessTask(this.fileExecutor, new SuccessContinuation() { // from class: com.google.firebase.messaging.FirebaseMessaging$$ExternalSyntheticLambda9
            @Override // com.google.android.gms.tasks.SuccessContinuation
            public final Task then(Object obj) {
                return this.f$0.m290lambda$blockingGetToken$13$comgooglefirebasemessagingFirebaseMessaging(str, token, (String) obj);
            }
        });
    }
    ...
    /* synthetic */ Task m290lambda$blockingGetToken$13$comgooglefirebasemessagingFirebaseMessaging(String str, Store.Token token, String str2) throws Exception {
        getStore(this.context).saveToken(getSubtype(), str, str2, this.metadata.getAppVersionCode());
        if (token == null || !str2.equals(token.token)) {
            m296lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(str2);
        }
    ...
    public void m296lambda$new$1$comgooglefirebasemessagingFirebaseMessaging(String str) {
        if (FirebaseApp.DEFAULT_APP_NAME.equals(this.firebaseApp.getName())) {
    ...
    class AutoInit {
            ...
            if (enabled == null) {
                EventHandler<DataCollectionDefaultChange> eventHandler = new EventHandler() { // from class: com.google.firebase.messaging.FirebaseMessaging$AutoInit$$ExternalSyntheticLambda0
                    ...
                    public final void handle(Event event) {
                        this.f$0.m301lambda$initialize$0$comgooglefirebasemessagingFirebaseMessaging$AutoInit(event);
                    }
                };
        ...
        /* synthetic */ void m301lambda$initialize$0$comgooglefirebasemessagingFirebaseMessaging$AutoInit(Event event) {
            if (isEnabled()) {
