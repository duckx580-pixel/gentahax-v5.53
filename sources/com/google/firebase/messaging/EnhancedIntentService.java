...
public abstract class EnhancedIntentService extends Service {
    ...
    public Task<Void> processIntent(final Intent intent) {
        ...
        this.executor.execute(new Runnable() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda1
            ...
            public final void run() {
                this.f$0.m288lambda$processIntent$0$comgooglefirebasemessagingEnhancedIntentService(intent, taskCompletionSource);
            }
        });
    ...
    /* synthetic */ void m288lambda$processIntent$0$comgooglefirebasemessagingEnhancedIntentService(Intent intent, TaskCompletionSource taskCompletionSource) {
        try {
            handleIntent(intent);
        } finally {
    ...
    public final int onStartCommand(final Intent intent, int i, int i2) {
        ...
        taskProcessIntent.addOnCompleteListener(new CredentialManager$$ExternalSyntheticLambda0(), new OnCompleteListener() { // from class: com.google.firebase.messaging.EnhancedIntentService$$ExternalSyntheticLambda0
            ...
            public final void onComplete(Task task) {
                this.f$0.m287lambda$onStartCommand$1$comgooglefirebasemessagingEnhancedIntentService(intent, task);
            }
        });
        return 3;
    }
    ...
    /* synthetic */ void m287lambda$onStartCommand$1$comgooglefirebasemessagingEnhancedIntentService(Intent intent, Task task) {
        finishTask(intent);
    }
