...
public class DefaultHeartBeatController implements HeartBeatController, HeartBeatInfo {
    ...
    public Task<Void> registerHeartBeat() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.DefaultHeartBeatController$$ExternalSyntheticLambda3
            ...
            public final Object call() {
                return this.f$0.m283lambda$registerHeartBeat$0$comgooglefirebaseheartbeatinfoDefaultHeartBeatController();
            }
        });
    }
    ...
    /* synthetic */ Void m283lambda$registerHeartBeat$0$comgooglefirebaseheartbeatinfoDefaultHeartBeatController() throws Exception {
        synchronized (this) {
    ...
    public Task<String> getHeartBeatsHeader() {
        ...
        return Tasks.call(this.backgroundExecutor, new Callable() { // from class: com.google.firebase.heartbeatinfo.DefaultHeartBeatController$$ExternalSyntheticLambda1
            @Override // java.util.concurrent.Callable
            public final Object call() {
                return this.f$0.m282lambda$getHeartBeatsHeader$1$comgooglefirebaseheartbeatinfoDefaultHeartBeatController();
            }
        });
    }
    ...
    /* synthetic */ String m282lambda$getHeartBeatsHeader$1$comgooglefirebaseheartbeatinfoDefaultHeartBeatController() throws Exception {
        String string;
        synchronized (this) {
