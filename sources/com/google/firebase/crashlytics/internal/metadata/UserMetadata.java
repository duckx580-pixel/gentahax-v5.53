...
public class UserMetadata {
        ...
        synchronized (this.sessionIdentifier) {
            ...
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.metadata.UserMetadata$$ExternalSyntheticLambda1
                ...
                public final void run() throws Throwable {
                    this.f$0.m270lambda$setNewSession$0$comgooglefirebasecrashlyticsinternalmetadataUserMetadata(str, keys, rolloutAssignmentList);
                }
            });
        }
    }
    ...
    /* synthetic */ void m270lambda$setNewSession$0$comgooglefirebasecrashlyticsinternalmetadataUserMetadata(String str, Map map, List list) throws Throwable {
        if (getUserId() != null) {
    ...
    public boolean updateRolloutsState(List<RolloutAssignment> list) {
        synchronized (this.rolloutsState) {
            ...
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.metadata.UserMetadata$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() throws Throwable {
                    this.f$0.m271lambda$updateRolloutsState$1$comgooglefirebasecrashlyticsinternalmetadataUserMetadata(rolloutAssignmentList);
                }
            });
            return true;
        }
    ...
    /* synthetic */ void m271lambda$updateRolloutsState$1$comgooglefirebasecrashlyticsinternalmetadataUserMetadata(List list) throws Throwable {
    ...
    class SerializeableKeysMap {
        ...
        private void scheduleSerializationTaskIfNeeded() {
            Runnable runnable = new Runnable() { // from class: com.google.firebase.crashlytics.internal.metadata.UserMetadata$SerializeableKeysMap$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() throws Throwable {
                    this.f$0.m272lambda$scheduleSerializationTaskIfNeeded$0$comgooglefirebasecrashlyticsinternalmetadataUserMetadata$SerializeableKeysMap();
                }
            };
        ...
        /* synthetic */ void m272lambda$scheduleSerializationTaskIfNeeded$0$comgooglefirebasecrashlyticsinternalmetadataUserMetadata$SerializeableKeysMap() throws Throwable {
