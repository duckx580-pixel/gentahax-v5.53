...
class CrashlyticsController {
    ...
    void openSession(final String str) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsController$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m257lambda$openSession$1$comgooglefirebasecrashlyticsinternalcommonCrashlyticsController(str);
            }
        });
    }
    ...
    /* synthetic */ void m257lambda$openSession$1$comgooglefirebasecrashlyticsinternalcommonCrashlyticsController(String str) {
