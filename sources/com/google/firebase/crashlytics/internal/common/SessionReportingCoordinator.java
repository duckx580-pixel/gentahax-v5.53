...
public class SessionReportingCoordinator {
        ...
        if (!z) {
            this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.SessionReportingCoordinator$$ExternalSyntheticLambda0
                ...
                public final void run() {
                    this.f$0.m269lambda$persistEvent$0$comgooglefirebasecrashlyticsinternalcommonSessionReportingCoordinator(eventAddMetaDataToEvent, eventMetadata, zEquals);
                }
            });
        } else {
    ...
    /* synthetic */ void m269lambda$persistEvent$0$comgooglefirebasecrashlyticsinternalcommonSessionReportingCoordinator(CrashlyticsReport.Session.Event event, EventMetadata eventMetadata, boolean z) {
