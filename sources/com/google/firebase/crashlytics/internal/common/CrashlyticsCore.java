...
public class CrashlyticsCore {
    ...
    public Task<Void> doBackgroundInitializationAsync(final SettingsProvider settingsProvider) {
        return this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m259lambda$doBackgroundInitializationAsync$0$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(settingsProvider);
            }
        });
    }
    ...
    public void m260lambda$finishInitSynchronously$9$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(SettingsProvider settingsProvider) {
    ...
    public void logException(final Throwable th, final Map<String, String> map) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda8
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m263lambda$logException$1$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(th, map);
            }
        });
    }
    ...
    /* synthetic */ void m263lambda$logException$1$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(Throwable th, Map map) {
    ...
    public void log(final String str) {
        ...
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda11
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m262lambda$log$3$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(jCurrentTimeMillis, str);
            }
        });
    }
    ...
    /* synthetic */ void m261lambda$log$2$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(long j, String str) {
    ...
    /* synthetic */ void m262lambda$log$3$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(final long j, final String str) {
        this.crashlyticsWorkers.diskWrite.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda9
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m261lambda$log$2$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(j, str);
            }
        });
    }
    ...
    /* synthetic */ void m268lambda$setUserId$4$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(String str) {
    ...
    public void setUserId(final String str) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda5
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m268lambda$setUserId$4$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(str);
            }
        });
    }
    ...
    /* synthetic */ void m265lambda$setCustomKey$5$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(String str, String str2) {
    ...
    public void setCustomKey(final String str, final String str2) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda6
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m265lambda$setCustomKey$5$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(str, str2);
            }
        });
    }
    ...
    public void setCustomKeys(final Map<String, String> map) {
        ...
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m266lambda$setCustomKeys$6$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(map);
            }
        });
    }
    ...
    /* synthetic */ void m266lambda$setCustomKeys$6$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(Map map) {
    ...
    /* synthetic */ void m267lambda$setInternalKey$7$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(String str, String str2) {
    ...
    public void setInternalKey(final String str, final String str2) {
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda7
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m267lambda$setInternalKey$7$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(str, str2);
            }
        });
    }
    ...
    public void logFatalException(final Throwable th) {
        ...
        this.crashlyticsWorkers.common.submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m264lambda$logFatalException$8$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(th);
            }
        });
    }
    ...
    /* synthetic */ void m264lambda$logFatalException$8$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(Throwable th) {
    ...
    private void finishInitSynchronously(final SettingsProvider settingsProvider) {
        Future<?> futureSubmit = this.crashlyticsWorkers.common.getExecutor().submit(new Runnable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m260lambda$finishInitSynchronously$9$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore(settingsProvider);
            }
        });
        ...
        try {
            this.didCrashOnPreviousExecution = Boolean.TRUE.equals((Boolean) this.crashlyticsWorkers.common.getExecutor().submit(new Callable() { // from class: com.google.firebase.crashlytics.internal.common.CrashlyticsCore$$ExternalSyntheticLambda10
                ...
                public final Object call() {
                    return this.f$0.m258lambda$checkForPreviousCrash$10$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore();
                }
    ...
    /* synthetic */ Boolean m258lambda$checkForPreviousCrash$10$comgooglefirebasecrashlyticsinternalcommonCrashlyticsCore() throws Exception {
