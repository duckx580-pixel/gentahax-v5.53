...
final class ReportQueue {
    ...
    public void flushScheduledReportsIfAble() {
        ...
        new Thread(new Runnable() { // from class: com.google.firebase.crashlytics.internal.send.ReportQueue$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m278lambda$flushScheduledReportsIfAble$0$comgooglefirebasecrashlyticsinternalsendReportQueue(countDownLatch);
            }
        }).start();
    ...
    /* synthetic */ void m278lambda$flushScheduledReportsIfAble$0$comgooglefirebasecrashlyticsinternalsendReportQueue(CountDownLatch countDownLatch) {
        try {
    ...
    public void sendReport(final CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, final TaskCompletionSource<CrashlyticsReportWithSessionId> taskCompletionSource) {
        ...
        this.transport.schedule(Event.ofUrgent(crashlyticsReportWithSessionId.getReport()), new TransportScheduleCallback() { // from class: com.google.firebase.crashlytics.internal.send.ReportQueue$$ExternalSyntheticLambda1
            ...
            public final void onSchedule(Exception exc) {
                this.f$0.m279lambda$sendReport$1$comgooglefirebasecrashlyticsinternalsendReportQueue(taskCompletionSource, z, crashlyticsReportWithSessionId, exc);
            }
        });
    }
    ...
    /* synthetic */ void m279lambda$sendReport$1$comgooglefirebasecrashlyticsinternalsendReportQueue(TaskCompletionSource taskCompletionSource, boolean z, CrashlyticsReportWithSessionId crashlyticsReportWithSessionId, Exception exc) {
        if (exc != null) {
