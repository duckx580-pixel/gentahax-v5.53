...
public class AnalyticsDeferredProxy {
    ...
    public BreadcrumbSource getDeferredBreadcrumbSource() {
        return new BreadcrumbSource() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda0
            ...
            public final void registerBreadcrumbHandler(BreadcrumbHandler breadcrumbHandler) {
                this.f$0.m254lambda$getDeferredBreadcrumbSource$0$comgooglefirebasecrashlyticsAnalyticsDeferredProxy(breadcrumbHandler);
            }
        };
    }
    ...
    /* synthetic */ void m254lambda$getDeferredBreadcrumbSource$0$comgooglefirebasecrashlyticsAnalyticsDeferredProxy(BreadcrumbHandler breadcrumbHandler) {
        synchronized (this) {
    ...
    public AnalyticsEventLogger getAnalyticsEventLogger() {
        return new AnalyticsEventLogger() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda1
            ...
            public final void logEvent(String str, Bundle bundle) {
                this.f$0.m253lambda$getAnalyticsEventLogger$1$comgooglefirebasecrashlyticsAnalyticsDeferredProxy(str, bundle);
            }
        };
    }
    ...
    /* synthetic */ void m253lambda$getAnalyticsEventLogger$1$comgooglefirebasecrashlyticsAnalyticsDeferredProxy(String str, Bundle bundle) {
    ...
    private void init() {
        this.analyticsConnectorDeferred.whenAvailable(new Deferred.DeferredHandler() { // from class: com.google.firebase.crashlytics.AnalyticsDeferredProxy$$ExternalSyntheticLambda2
            ...
            public final void handle(Provider provider) {
                this.f$0.m255lambda$init$2$comgooglefirebasecrashlyticsAnalyticsDeferredProxy(provider);
            }
        });
    }

    /* JADX INFO: renamed from: lambda$init$2$com-google-firebase-crashlytics-AnalyticsDeferredProxy, reason: not valid java name */
    /* synthetic */ void m255lambda$init$2$comgooglefirebasecrashlyticsAnalyticsDeferredProxy(Provider provider) {
