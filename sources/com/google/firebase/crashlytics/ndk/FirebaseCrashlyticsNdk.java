...
class FirebaseCrashlyticsNdk implements CrashlyticsNativeComponent {
            ...
            try {
                ...
                SignalHandlerInstaller signalHandlerInstaller = new SignalHandlerInstaller() { // from class: com.google.firebase.crashlytics.ndk.FirebaseCrashlyticsNdk$$ExternalSyntheticLambda0
                    ...
                    public final void installHandler() {
                        this.f$0.m281lambda$prepareNativeSession$0$comgooglefirebasecrashlyticsndkFirebaseCrashlyticsNdk(str, str2, j, staticSessionData);
                    }
                };
    ...
    /* synthetic */ void m281lambda$prepareNativeSession$0$comgooglefirebasecrashlyticsndkFirebaseCrashlyticsNdk(String str, String str2, long j, StaticSessionData staticSessionData) {
