...
class LimitedConcurrencyExecutor implements Executor {
    ...
    private Runnable decorate(final Runnable runnable) {
        return new Runnable() { // from class: com.google.firebase.concurrent.LimitedConcurrencyExecutor$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m252lambda$decorate$0$comgooglefirebaseconcurrentLimitedConcurrencyExecutor(runnable);
            }
        };
    }
    ...
    /* synthetic */ void m252lambda$decorate$0$comgooglefirebaseconcurrentLimitedConcurrencyExecutor(Runnable runnable) {
        try {
            runnable.run();
        } finally {
            this.semaphore.release();
