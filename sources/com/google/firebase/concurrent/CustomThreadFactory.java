...
class CustomThreadFactory implements ThreadFactory {
    ...
    public Thread newThread(final Runnable runnable) {
        Thread threadNewThread = DEFAULT.newThread(new Runnable() { // from class: com.google.firebase.concurrent.CustomThreadFactory$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m243lambda$newThread$0$comgooglefirebaseconcurrentCustomThreadFactory(runnable);
            }
        });
    ...
    /* synthetic */ void m243lambda$newThread$0$comgooglefirebaseconcurrentCustomThreadFactory(Runnable runnable) {
