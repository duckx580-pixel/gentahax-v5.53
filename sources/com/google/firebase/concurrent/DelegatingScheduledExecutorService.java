...
class DelegatingScheduledExecutorService implements ScheduledExecutorService {
    ...
    public ScheduledFuture<?> schedule(final Runnable runnable, final long j, final TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new DelegatingScheduledFuture.Resolver() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda0
            ...
            public final ScheduledFuture addCompleter(DelegatingScheduledFuture.Completer completer) {
                return this.f$0.m245lambda$schedule$2$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(runnable, j, timeUnit, completer);
            }
        });
    }
    ...
    /* synthetic */ ScheduledFuture m245lambda$schedule$2$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Runnable runnable, long j, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
        return this.scheduler.schedule(new Runnable() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda4
            ...
            public final void run() {
                this.f$0.m244lambda$schedule$1$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(runnable, completer);
            }
        }, j, timeUnit);
    }
    ...
    /* synthetic */ void m244lambda$schedule$1$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Runnable runnable, final DelegatingScheduledFuture.Completer completer) {
    ...
    public <V> ScheduledFuture<V> schedule(final Callable<V> callable, final long j, final TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new DelegatingScheduledFuture.Resolver() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda8
            @Override // com.google.firebase.concurrent.DelegatingScheduledFuture.Resolver
            public final ScheduledFuture addCompleter(DelegatingScheduledFuture.Completer completer) {
                return this.f$0.m247lambda$schedule$5$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(callable, j, timeUnit, completer);
            }
        });
    }
    ...
    /* synthetic */ ScheduledFuture m247lambda$schedule$5$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Callable callable, long j, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
        return this.scheduler.schedule(new Callable() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda10
            ...
            public final Object call() {
                return this.f$0.m246lambda$schedule$4$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(callable, completer);
            }
        }, j, timeUnit);
    }
    ...
    /* synthetic */ Future m246lambda$schedule$4$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Callable callable, final DelegatingScheduledFuture.Completer completer) throws Exception {
    ...
    public ScheduledFuture<?> scheduleAtFixedRate(final Runnable runnable, final long j, final long j2, final TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new DelegatingScheduledFuture.Resolver() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda5
            @Override // com.google.firebase.concurrent.DelegatingScheduledFuture.Resolver
            public final ScheduledFuture addCompleter(DelegatingScheduledFuture.Completer completer) {
                return this.f$0.m249lambda$scheduleAtFixedRate$8$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(runnable, j, j2, timeUnit, completer);
            }
        });
    }
    ...
    /* synthetic */ ScheduledFuture m249lambda$scheduleAtFixedRate$8$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Runnable runnable, long j, long j2, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
        return this.scheduler.scheduleAtFixedRate(new Runnable() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda3
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m248lambda$scheduleAtFixedRate$7$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(runnable, completer);
            }
        }, j, j2, timeUnit);
    }
    ...
    /* synthetic */ void m248lambda$scheduleAtFixedRate$7$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Runnable runnable, final DelegatingScheduledFuture.Completer completer) {
    ...
    public ScheduledFuture<?> scheduleWithFixedDelay(final Runnable runnable, final long j, final long j2, final TimeUnit timeUnit) {
        return new DelegatingScheduledFuture(new DelegatingScheduledFuture.Resolver() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda7
            @Override // com.google.firebase.concurrent.DelegatingScheduledFuture.Resolver
            public final ScheduledFuture addCompleter(DelegatingScheduledFuture.Completer completer) {
                return this.f$0.m251lambda$scheduleWithFixedDelay$11$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(runnable, j, j2, timeUnit, completer);
            }
        });
    }
    ...
    /* synthetic */ ScheduledFuture m251lambda$scheduleWithFixedDelay$11$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Runnable runnable, long j, long j2, TimeUnit timeUnit, final DelegatingScheduledFuture.Completer completer) {
        return this.scheduler.scheduleWithFixedDelay(new Runnable() { // from class: com.google.firebase.concurrent.DelegatingScheduledExecutorService$$ExternalSyntheticLambda2
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m250lambda$scheduleWithFixedDelay$10$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(runnable, completer);
            }
        }, j, j2, timeUnit);
    }
    ...
    /* synthetic */ void m250lambda$scheduleWithFixedDelay$10$comgooglefirebaseconcurrentDelegatingScheduledExecutorService(final Runnable runnable, final DelegatingScheduledFuture.Completer completer) {
