...
public class ComponentRuntime implements ComponentContainer, ComponentLoader {
        ...
        synchronized (this) {
            ...
            for (final Component<?> component : list) {
                this.components.put(component, new Lazy(new Provider() { // from class: com.google.firebase.components.ComponentRuntime$$ExternalSyntheticLambda2
                    @Override // com.google.firebase.inject.Provider
                    public final Object get() {
                        return this.f$0.m242lambda$discoverComponents$0$comgooglefirebasecomponentsComponentRuntime(component);
                    }
                }));
            }
    ...
    /* synthetic */ Object m242lambda$discoverComponents$0$comgooglefirebasecomponentsComponentRuntime(Component component) {
