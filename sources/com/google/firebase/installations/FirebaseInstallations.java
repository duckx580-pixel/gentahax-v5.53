...
public class FirebaseInstallations implements FirebaseInstallationsApi {
    ...
    public Task<String> getId() {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda2
            ...
            public final void run() {
                this.f$0.m285lambda$getId$1$comgooglefirebaseinstallationsFirebaseInstallations();
            }
        });
    ...
    /* synthetic */ void m285lambda$getId$1$comgooglefirebaseinstallationsFirebaseInstallations() {
        m286lambda$getToken$2$comgooglefirebaseinstallationsFirebaseInstallations(false);
    }
    ...
    public Task<InstallationTokenResult> getToken(final boolean z) {
        ...
        this.backgroundExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda4
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m286lambda$getToken$2$comgooglefirebaseinstallationsFirebaseInstallations(z);
            }
        });
    ...
    public final void m286lambda$getToken$2$comgooglefirebaseinstallationsFirebaseInstallations(final boolean z) {
        ...
        this.networkExecutor.execute(new Runnable() { // from class: com.google.firebase.installations.FirebaseInstallations$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m284lambda$doRegistrationOrRefresh$3$comgooglefirebaseinstallationsFirebaseInstallations(z);
            }
        });
    }
    ...
    public void m284lambda$doRegistrationOrRefresh$3$comgooglefirebaseinstallationsFirebaseInstallations(boolean z) {
