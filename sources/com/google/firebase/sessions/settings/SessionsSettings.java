...
public final class SessionsSettings {
    ...
    public final long m310getSessionRestartTimeoutUwyO8pc() {
        Duration durationMo308getSessionRestartTimeoutFghU774 = this.localOverrideSettings.mo308getSessionRestartTimeoutFghU774();
        if (durationMo308getSessionRestartTimeoutFghU774 != null) {
            long rawValue = durationMo308getSessionRestartTimeoutFghU774.getRawValue();
            if (m309isValidSessionRestartTimeoutLRDsOJo(rawValue)) {
                return rawValue;
            }
        }
        Duration durationMo308getSessionRestartTimeoutFghU7742 = this.remoteSettings.mo308getSessionRestartTimeoutFghU774();
        if (durationMo308getSessionRestartTimeoutFghU7742 != null) {
            long rawValue2 = durationMo308getSessionRestartTimeoutFghU7742.getRawValue();
            if (m309isValidSessionRestartTimeoutLRDsOJo(rawValue2)) {
                return rawValue2;
            }
        }
    ...
    private final boolean m309isValidSessionRestartTimeoutLRDsOJo(long sessionRestartTimeout) {
        return Duration.m4963isPositiveimpl(sessionRestartTimeout) && Duration.m4958isFiniteimpl(sessionRestartTimeout);
    }
    ...
    */
    ...
    /* JADX INFO: compiled from: SessionsSettings.kt */
    @Metadata(d1 = {"\u0000\u0014\n\u0002\u0018\u0002\n\u0002\u0010\u0000\n\u0002\b\u0002\n\u0002\u0018\u0002\n\u0002\b\u0003\b\u0080\u0003\u0018\u00002\u00020\u0001B\u0007\b\u0002¢\u0006\u0002\u0010\u0002R\u0011\u0010\u0003\u001a\u00020\u00048F¢\u0006\u0006\u001a\u0004\b\u0005\u0010\u0006¨\u0006\u0007"}, d2 = {"Lcom/google/firebase/sessions/settings/SessionsSettings$Companion;", "", "()V", f5.o, "Lcom/google/firebase/sessions/settings/SessionsSettings;", "getInstance", "()Lcom/google/firebase/sessions/settings/SessionsSettings;", "com.google.firebase-firebase-sessions"}, k = 1, mv = {1, 8, 0}, xi = 48)
