...
public class JobInfoSchedulerService extends JobService {
    ...
    public boolean onStartJob(final JobParameters jobParameters) {
        ...
        TransportRuntime.getInstance().getUploader().upload(priority.build(), i2, new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.jobscheduling.JobInfoSchedulerService$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m114lambda$onStartJob$0$comgoogleandroiddatatransportruntimeschedulingjobschedulingJobInfoSchedulerService(jobParameters);
            }
        });
        return true;
    }
    ...
    /* synthetic */ void m114lambda$onStartJob$0$comgoogleandroiddatatransportruntimeschedulingjobschedulingJobInfoSchedulerService(JobParameters jobParameters) {
