...
public class WorkInitializer {
    ...
    public void ensureContextsScheduled() {
        this.executor.execute(new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.jobscheduling.WorkInitializer$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m125lambda$ensureContextsScheduled$1$comgoogleandroiddatatransportruntimeschedulingjobschedulingWorkInitializer();
            }
        });
    }
    ...
    /* synthetic */ void m125lambda$ensureContextsScheduled$1$comgoogleandroiddatatransportruntimeschedulingjobschedulingWorkInitializer() {
        this.guard.runCriticalSection(new SynchronizationGuard.CriticalSection() { // from class: com.google.android.datatransport.runtime.scheduling.jobscheduling.WorkInitializer$$ExternalSyntheticLambda1
            ...
            public final Object execute() {
                return this.f$0.m124lambda$ensureContextsScheduled$0$comgoogleandroiddatatransportruntimeschedulingjobschedulingWorkInitializer();
            }
        });
    }
    ...
    /* synthetic */ Object m124lambda$ensureContextsScheduled$0$comgoogleandroiddatatransportruntimeschedulingjobschedulingWorkInitializer() {
