...
public class DefaultScheduler implements Scheduler {
    ...
    public void schedule(final TransportContext transportContext, final EventInternal eventInternal, final TransportScheduleCallback transportScheduleCallback) {
        this.executor.execute(new Runnable() { // from class: com.google.android.datatransport.runtime.scheduling.DefaultScheduler$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m113lambda$schedule$1$comgoogleandroiddatatransportruntimeschedulingDefaultScheduler(transportContext, transportScheduleCallback, eventInternal);
            }
        });
    }
    ...
    /* synthetic */ void m113lambda$schedule$1$comgoogleandroiddatatransportruntimeschedulingDefaultScheduler(final TransportContext transportContext, TransportScheduleCallback transportScheduleCallback, EventInternal eventInternal) {
        try {
            ...
            if (transportBackend == null) {
                ...
                this.guard.runCriticalSection(new SynchronizationGuard.CriticalSection() { // from class: com.google.android.datatransport.runtime.scheduling.DefaultScheduler$$ExternalSyntheticLambda1
                    ...
                    public final Object execute() {
                        return this.f$0.m112lambda$schedule$0$comgoogleandroiddatatransportruntimeschedulingDefaultScheduler(transportContext, eventInternalDecorate);
                    }
                });
    ...
    /* synthetic */ Object m112lambda$schedule$0$comgoogleandroiddatatransportruntimeschedulingDefaultScheduler(TransportContext transportContext, EventInternal eventInternal) {
