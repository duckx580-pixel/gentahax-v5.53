...
public class SQLiteEventStore implements EventStore, SynchronizationGuard, ClientHealthMetricsStore {
    ...
    public PersistedEvent persist(final TransportContext transportContext, final EventInternal eventInternal) {
        ...
        long jLongValue = ((Long) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda4
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m133lambda$persist$1$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(eventInternal, transportContext, (SQLiteDatabase) obj);
            }
        })).longValue();
        if (jLongValue < 1) {
            return null;
    ...
    /* synthetic */ Long m133lambda$persist$1$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(EventInternal eventInternal, TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        if (isStorageAtLimit()) {
    ...
    public void recordFailure(Iterable<PersistedEvent> iterable) {
        if (iterable.iterator().hasNext()) {
            ...
            inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda11
                @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
                public final Object apply(Object obj) {
                    return this.f$0.m135lambda$recordFailure$4$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(str, str2, (SQLiteDatabase) obj);
                }
            });
        }
    }
    ...
    /* synthetic */ Object m135lambda$recordFailure$4$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, String str2, SQLiteDatabase sQLiteDatabase) {
        ...
        tryWithCursor(sQLiteDatabase.rawQuery(str2, null), new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda27
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m134lambda$recordFailure$3$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore((Cursor) obj);
            }
        });
    ...
    /* synthetic */ Object m134lambda$recordFailure$3$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
    ...
    public boolean hasPendingEventsFor(final TransportContext transportContext) {
        return ((Boolean) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda5
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m128lambda$hasPendingEventsFor$6$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(transportContext, (SQLiteDatabase) obj);
            }
        })).booleanValue();
    }
    ...
    /* synthetic */ Boolean m128lambda$hasPendingEventsFor$6$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
        Long transportContextId = getTransportContextId(sQLiteDatabase, transportContext);
        if (transportContextId == null) {
            return false;
        }
    ...
    public Iterable<PersistedEvent> loadBatch(final TransportContext transportContext) {
        return (Iterable) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda24
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m129lambda$loadBatch$8$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(transportContext, (SQLiteDatabase) obj);
            }
        });
    }
    ...
    /* synthetic */ List m129lambda$loadBatch$8$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(TransportContext transportContext, SQLiteDatabase sQLiteDatabase) {
    ...
    public int cleanUp() {
        ...
        return ((Integer) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda10
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m127lambda$cleanUp$12$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(time, (SQLiteDatabase) obj);
            }
        })).intValue();
    }
    ...
    /* synthetic */ Integer m127lambda$cleanUp$12$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(long j, SQLiteDatabase sQLiteDatabase) {
        ...
        tryWithCursor(sQLiteDatabase.rawQuery("SELECT COUNT(*), transport_name FROM events WHERE timestamp_ms < ? GROUP BY transport_name", strArr), new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda19
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m126lambda$cleanUp$11$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore((Cursor) obj);
            }
        });
    ...
    /* synthetic */ Object m126lambda$cleanUp$11$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    private List<PersistedEvent> loadEvents(SQLiteDatabase sQLiteDatabase, final TransportContext transportContext, int i) {
        ...
        tryWithCursor(sQLiteDatabase.query("events", new String[]{"_id", "transport_name", "timestamp_ms", "uptime_ms", "payload_encoding", "payload", "code", TJAdUnitConstants.String.INLINE, "product_id", "pseudonymous_id", "experiment_ids_clear_blob", "experiment_ids_encrypted_blob"}, "context_id = ?", new String[]{transportContextId.toString()}, null, null, null, String.valueOf(i)), new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda1
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m132lambda$loadEvents$14$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(arrayList, transportContext, (Cursor) obj);
            }
        });
        return arrayList;
    }
    ...
    /* synthetic */ Object m132lambda$loadEvents$14$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(List list, TransportContext transportContext, Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    public ClientMetrics loadClientMetrics() {
        ...
        return (ClientMetrics) inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda0
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m131lambda$loadClientMetrics$20$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(str, map, builderNewBuilder, (SQLiteDatabase) obj);
            }
        });
    }
    ...
    /* synthetic */ ClientMetrics m131lambda$loadClientMetrics$20$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(String str, final Map map, final ClientMetrics.Builder builder, SQLiteDatabase sQLiteDatabase) {
        return (ClientMetrics) tryWithCursor(sQLiteDatabase.rawQuery(str, new String[0]), new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda6
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m130lambda$loadClientMetrics$19$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(map, builder, (Cursor) obj);
            }
        });
    }
    ...
    /* synthetic */ ClientMetrics m130lambda$loadClientMetrics$19$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(Map map, ClientMetrics.Builder builder, Cursor cursor) {
        while (cursor.moveToNext()) {
    ...
    public void resetClientMetrics() {
        inTransaction(new Function() { // from class: com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore$$ExternalSyntheticLambda8
            @Override // com.google.android.datatransport.runtime.scheduling.persistence.SQLiteEventStore.Function
            public final Object apply(Object obj) {
                return this.f$0.m136lambda$resetClientMetrics$23$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore((SQLiteDatabase) obj);
            }
        });
    }
    ...
    /* synthetic */ Object m136lambda$resetClientMetrics$23$comgoogleandroiddatatransportruntimeschedulingpersistenceSQLiteEventStore(SQLiteDatabase sQLiteDatabase) {
