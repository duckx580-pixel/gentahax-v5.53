...
class SearchBarAnimationHelper {
    ...
    void startExpandAnimation(final SearchBar searchBar, final View view, final AppBarLayout appBarLayout, final boolean z) {
        ...
        view.post(new Runnable() { // from class: com.google.android.material.search.SearchBarAnimationHelper$$ExternalSyntheticLambda3
            ...
            public final void run() {
                this.f$0.m195lambda$startExpandAnimation$0$comgoogleandroidmaterialsearchSearchBarAnimationHelper(searchBar, view, appBarLayout, z);
            }
        });
    }
    ...
    /* synthetic */ void m195lambda$startExpandAnimation$0$comgoogleandroidmaterialsearchSearchBarAnimationHelper(SearchBar searchBar, View view, AppBarLayout appBarLayout, boolean z) {
        AnimatorSet animatorSet = new AnimatorSet();
