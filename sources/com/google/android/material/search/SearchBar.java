...
public class SearchBar extends Toolbar {
    ...
    /* synthetic */ void m193lambda$new$0$comgoogleandroidmaterialsearchSearchBar(boolean z) {
    ...
    public SearchBar(Context context, AttributeSet attributeSet, int i) {
        ...
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda1
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m193lambda$new$0$comgoogleandroidmaterialsearchSearchBar(z);
            }
        };
    ...
    /* synthetic */ void m194lambda$startOnLoadAnimation$1$comgoogleandroidmaterialsearchSearchBar() {
    ...
    public void startOnLoadAnimation() {
        post(new Runnable() { // from class: com.google.android.material.search.SearchBar$$ExternalSyntheticLambda0
            ...
            public final void run() {
                this.f$0.m194lambda$startOnLoadAnimation$1$comgoogleandroidmaterialsearchSearchBar();
            }
        });
    }
