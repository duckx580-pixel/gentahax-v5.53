...
public class MaskableFrameLayout extends FrameLayout implements Maskable, Shapeable {
    ...
    protected void dispatchDraw(Canvas canvas) {
        this.shapeableDelegate.maybeClip(canvas, new CanvasCompat.CanvasOperation() { // from class: com.google.android.material.carousel.MaskableFrameLayout$$ExternalSyntheticLambda1
            ...
            public final void run(Canvas canvas2) {
                this.f$0.m143lambda$dispatchDraw$1$comgoogleandroidmaterialcarouselMaskableFrameLayout(canvas2);
            }
        });
    }
    ...
    /* synthetic */ void m143lambda$dispatchDraw$1$comgoogleandroidmaterialcarouselMaskableFrameLayout(Canvas canvas) {
