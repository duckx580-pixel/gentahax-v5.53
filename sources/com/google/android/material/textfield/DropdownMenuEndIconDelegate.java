...
class DropdownMenuEndIconDelegate extends EndIconDelegate {
    ...
    /* synthetic */ void m220lambda$new$0$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(View view) {
        showHideDropdown();
    }
    ...
    /* synthetic */ void m221lambda$new$1$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(View view, boolean z) {
    ...
    /* synthetic */ void m222lambda$new$2$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(boolean z) {
    ...
    DropdownMenuEndIconDelegate(EndCompoundLayout endCompoundLayout) {
        ...
        this.onIconClickListener = new View.OnClickListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda3
            ...
            public final void onClick(View view) {
                this.f$0.m220lambda$new$0$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(view);
            }
        };
        this.onEditTextFocusChangeListener = new View.OnFocusChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda4
            ...
            public final void onFocusChange(View view, boolean z) {
                this.f$0.m221lambda$new$1$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(view, z);
            }
        };
        this.touchExplorationStateChangeListener = new AccessibilityManagerCompat.TouchExplorationStateChangeListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda5
            ...
            public final void onTouchExplorationStateChanged(boolean z) {
                this.f$0.m222lambda$new$2$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(z);
            }
        };
    ...
    public void afterEditTextChanged(Editable editable) {
        ...
        this.autoCompleteTextView.post(new Runnable() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda6
            ...
            public final void run() {
                this.f$0.m218lambda$afterEditTextChanged$3$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate();
            }
        });
    }
    ...
    /* synthetic */ void m218lambda$afterEditTextChanged$3$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate() {
    ...
    private void setUpDropdownShowHideBehavior() {
        this.autoCompleteTextView.setOnTouchListener(new View.OnTouchListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda1
            ...
            public final boolean onTouch(View view, MotionEvent motionEvent) {
                return this.f$0.m223lambda$setUpDropdownShowHideBehavior$4$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(view, motionEvent);
            }
        });
        if (IS_LOLLIPOP) {
            this.autoCompleteTextView.setOnDismissListener(new AutoCompleteTextView.OnDismissListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda2
                ...
                public final void onDismiss() {
                    this.f$0.m224lambda$setUpDropdownShowHideBehavior$5$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate();
                }
            });
        }
    ...
    /* synthetic */ boolean m223lambda$setUpDropdownShowHideBehavior$4$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(View view, MotionEvent motionEvent) {
    ...
    /* synthetic */ void m224lambda$setUpDropdownShowHideBehavior$5$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate() {
        updateDropdownPopupDirty();
        setEndIconChecked(false);
    }
    ...
    private ValueAnimator getAlphaAnimator(int i, float... fArr) {
        ...
        valueAnimatorOfFloat.addUpdateListener(new ValueAnimator.AnimatorUpdateListener() { // from class: com.google.android.material.textfield.DropdownMenuEndIconDelegate$$ExternalSyntheticLambda0
            ...
            public final void onAnimationUpdate(ValueAnimator valueAnimator) {
                this.f$0.m219lambda$getAlphaAnimator$6$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(valueAnimator);
            }
        });
    ...
    /* synthetic */ void m219lambda$getAlphaAnimator$6$comgoogleandroidmaterialtextfieldDropdownMenuEndIconDelegate(ValueAnimator valueAnimator) {
