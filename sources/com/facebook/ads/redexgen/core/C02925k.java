...
public final class C02925k implements NativeAdApi {
    ...
    public C02925k(NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
        W7.A0L(nativeAdBaseApi).A1a(EnumC0620Jl.A06);
    }

    public C02925k(NativeAdBase nativeAdBase, NativeAd nativeAd, NativeAdBaseApi nativeAdBaseApi) {
        this.A00 = nativeAd;
        this.A01 = nativeAdBaseApi;
    }
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, ImageView imageView, List<View> clickableViews) {
        if (imageView != null) {
            C1036Zs c1036ZsA11 = A00().A11();
            C1036Zs downloadContext = C02835b.A03(imageView.getContext());
            downloadContext.A0K(c1036ZsA11);
    ...
    public final void registerViewForInteraction(View view, MediaView mediaView, MediaView mediaView2, List<View> list) {
        if (mediaView != null) {
            ((C1066aM) mediaView.getMediaViewApi()).A0L(this.A00);
        }
        if (mediaView2 != null) {
            ((C1066aM) mediaView2.getMediaViewApi()).A0M(this.A01, false);
        }
        if (list != null) {
