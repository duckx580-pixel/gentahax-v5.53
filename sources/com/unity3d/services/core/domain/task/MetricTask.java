...
public abstract class MetricTask<P extends BaseParams, R> implements BaseTask<P, R> {
    ...
    public Object mo3288invokegIAlus(P p, Continuation<? super Result<? extends R>> continuation) {
        return m3305invokegIAlus$suspendImpl(this, p, continuation);
    }
    ...
    */
    static /* synthetic */ java.lang.Object m3305invokegIAlus$suspendImpl(com.unity3d.services.core.domain.task.MetricTask<? super P, R> r8, P r9, kotlin.coroutines.Continuation<? super kotlin.Result<? extends R>> r10) {
        /*
        ...
        L52:
            ...
            r0.J$0 = r4
            r0.label = r3
            java.lang.Object r9 = com.unity3d.services.core.domain.task.BaseTask.DefaultImpls.m3289invokegIAlus(r8, r9, r0)
            if (r9 != r1) goto L75
            return r1
        L75:
            r0 = r8
        ...
        L7a:
            ...
            return r8
        */
        throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.MetricTask.m3305invokegIAlus$suspendImpl(com.unity3d.services.core.domain.task.MetricTask, com.unity3d.services.core.domain.task.BaseParams, kotlin.coroutines.Continuation):java.lang.Object");
    }

    private final void captureMetric(Object result) {
        this.taskStatus = Result.m3610isSuccessimpl(result) ? "success" : "failure";
        sendMetric();
    }
