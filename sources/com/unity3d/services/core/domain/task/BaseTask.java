...
public interface BaseTask<P extends BaseParams, R> extends IServiceComponent {
    ...
    Object mo3287doWorkgIAlus(P p, Continuation<? super Result<? extends R>> continuation);

    /* JADX INFO: renamed from: invoke-gIAlu-s, reason: not valid java name */
    Object mo3288invokegIAlus(P p, Continuation<? super Result<? extends R>> continuation);
    ...
    public static final class DefaultImpls {
        ...
        */
        public static <P extends com.unity3d.services.core.domain.task.BaseParams, R> java.lang.Object m3289invokegIAlus(com.unity3d.services.core.domain.task.BaseTask<? super P, R> r4, P r5, kotlin.coroutines.Continuation<? super kotlin.Result<? extends R>> r6) {
            /*
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r6)
                r0.label = r3
                java.lang.Object r4 = r4.mo3287doWorkgIAlus(r5, r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                return r4
            */
            throw new UnsupportedOperationException("Method not decompiled: com.unity3d.services.core.domain.task.BaseTask.DefaultImpls.m3289invokegIAlus(com.unity3d.services.core.domain.task.BaseTask, com.unity3d.services.core.domain.task.BaseParams, kotlin.coroutines.Continuation):java.lang.Object");
        }
    }
}
