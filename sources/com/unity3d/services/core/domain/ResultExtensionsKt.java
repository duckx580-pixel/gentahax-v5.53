...
public final class ResultExtensionsKt {
    public static final /* synthetic */ <E extends Exception> E getCustomExceptionOrNull(Object obj) {
        ...
        if (thM3606exceptionOrNullimpl instanceof Exception) {
            return (E) thM3606exceptionOrNullimpl;
        }
        return null;
    }
    ...
    public static final InitializationException getInitializationExceptionOrNull(Object obj) {
        Throwable thM3606exceptionOrNullimpl = Result.m3606exceptionOrNullimpl(obj);
        if (thM3606exceptionOrNullimpl instanceof InitializationException) {
            return (InitializationException) thM3606exceptionOrNullimpl;
        }
        return null;
    }
