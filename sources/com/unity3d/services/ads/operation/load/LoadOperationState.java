...
public class LoadOperationState extends OperationState {
        ...
        if (this.listener != null) {
            Utilities.wrapCustomerListener(new Runnable() { // from class: com.unity3d.services.ads.operation.load.LoadOperationState$$ExternalSyntheticLambda1
                ...
                public final void run() {
                    this.f$0.m3281lambda$onUnityAdsFailedToLoad$0$comunity3dservicesadsoperationloadLoadOperationState(unityAdsLoadError, str);
                }
            });
        }
    }
    ...
    /* synthetic */ void m3281lambda$onUnityAdsFailedToLoad$0$comunity3dservicesadsoperationloadLoadOperationState(UnityAds.UnityAdsLoadError unityAdsLoadError, String str) {
    ...
    public void onUnityAdsAdLoaded() {
        if (this.listener != null) {
            Utilities.wrapCustomerListener(new Runnable() { // from class: com.unity3d.services.ads.operation.load.LoadOperationState$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m3280lambda$onUnityAdsAdLoaded$1$comunity3dservicesadsoperationloadLoadOperationState();
                }
            });
        }
    }
    ...
    /* synthetic */ void m3280lambda$onUnityAdsAdLoaded$1$comunity3dservicesadsoperationloadLoadOperationState() {
