...
public abstract class BiddingBaseManager implements IBiddingManager {
        ...
        if (this.unityAdsTokenListener != null) {
            Utilities.wrapCustomerListener(new Runnable() { // from class: com.unity3d.services.ads.gmascar.managers.BiddingBaseManager$$ExternalSyntheticLambda2
                ...
                public final void run() {
                    this.f$0.m3278lambda$onUnityAdsTokenReady$0$comunity3dservicesadsgmascarmanagersBiddingBaseManager(str);
                }
            });
        }
    }
    ...
    /* synthetic */ void m3278lambda$onUnityAdsTokenReady$0$comunity3dservicesadsgmascarmanagersBiddingBaseManager(String str) {
    ...
    public void fetchSignals() {
        ...
        new Thread(new Runnable() { // from class: com.unity3d.services.ads.gmascar.managers.BiddingBaseManager$$ExternalSyntheticLambda1
            @Override // java.lang.Runnable
            public final void run() {
                this.f$0.m3277lambda$fetchSignals$1$comunity3dservicesadsgmascarmanagersBiddingBaseManager();
            }
        }).start();
    }
    ...
    /* synthetic */ void m3277lambda$fetchSignals$1$comunity3dservicesadsgmascarmanagersBiddingBaseManager() {
    ...
    public void uploadSignals() {
        ...
        if (biddingSignals == null || biddingSignals.isEmpty()) {
            ...
            new Thread(new Runnable() { // from class: com.unity3d.services.ads.gmascar.managers.BiddingBaseManager$$ExternalSyntheticLambda0
                @Override // java.lang.Runnable
                public final void run() {
                    this.f$0.m3279lambda$uploadSignals$2$comunity3dservicesadsgmascarmanagersBiddingBaseManager(biddingSignals);
                }
            }).start();
        }
    }
    ...
    /* synthetic */ void m3279lambda$uploadSignals$2$comunity3dservicesadsgmascarmanagersBiddingBaseManager(BiddingSignals biddingSignals) {
        try {
