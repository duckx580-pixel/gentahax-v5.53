...
public final class AndroidByteStringDataSource implements ByteStringDataSource {
    ...
    public Object get(Continuation<? super ByteStringStoreOuterClass.ByteStringStore> continuation) {
        return FlowKt.first(FlowKt.m5134catch(this.dataStore.getData(), new AnonymousClass2(null)), continuation);
    }
    ...
    static final class C16572 extends SuspendLambda implements Function2<ByteStringStoreOuterClass.ByteStringStore, Continuation<? super ByteStringStoreOuterClass.ByteStringStore>, Object> {
        final /* synthetic */ ByteString $data;
        /* synthetic */ Object L$0;
        int label;

        /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
        C16572(ByteString byteString, Continuation<? super C16572> continuation) {
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            C16572 c16572 = new C16572(this.$data, continuation);
            c16572.L$0 = obj;
            return c16572;
        }
        ...
        public final Object invoke(ByteStringStoreOuterClass.ByteStringStore byteStringStore, Continuation<? super ByteStringStoreOuterClass.ByteStringStore> continuation) {
            return ((C16572) create(byteStringStore, continuation)).invokeSuspend(Unit.INSTANCE);
        }
    ...
    public Object set(ByteString byteString, Continuation<? super Unit> continuation) {
        Object objUpdateData = this.dataStore.updateData(new C16572(byteString, null), continuation);
