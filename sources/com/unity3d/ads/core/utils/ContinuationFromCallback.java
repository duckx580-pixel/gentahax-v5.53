...
public final class ContinuationFromCallback extends WebViewCallback {
    ...
    public void invoke(Object... params) {
        ...
        continuation.resumeWith(Result.m3603constructorimpl(params));
    }
    ...
    public void error(Enum<?> error, Object... params) {
        ...
        Continuation<Object> continuation = this.continuation;
        Result.Companion companion = Result.INSTANCE;
        continuation.resumeWith(Result.m3603constructorimpl(ResultKt.createFailure(new ExposureException("Invocation failed with: " + error, params))));
    }
}
