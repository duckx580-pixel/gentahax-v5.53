...
public final class AFi1zSDK {
    ...
    private static AFi1uSDK getCurrencyIso4217Code(JSONObject jSONObject) {
        ...
        try {
            ...
            objM3603constructorimpl = Result.m3603constructorimpl(jSONObjectAFAdRevenueData != null ? new AFi1uSDK(jSONObjectAFAdRevenueData.optDouble("send_rate", 1.0d)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th));
        }
        return (AFi1uSDK) (Result.m3609isFailureimpl(objM3603constructorimpl) ? null : objM3603constructorimpl);
    }
    ...
    private static AFh1aSDK getMediationNetwork(JSONObject jSONObject) {
        ...
        try {
            ...
            objM3603constructorimpl = Result.m3603constructorimpl(jSONObjectAFAdRevenueData != null ? new AFh1aSDK(jSONObjectAFAdRevenueData.getString("sdk_ver"), jSONObjectAFAdRevenueData.optInt("min", -1), jSONObjectAFAdRevenueData.optInt("expire", -1), jSONObjectAFAdRevenueData.optLong("ttl", -1L)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th));
        }
        return (AFh1aSDK) (Result.m3609isFailureimpl(objM3603constructorimpl) ? null : objM3603constructorimpl);
    }
    ...
    private static AFi1xSDK AFAdRevenueData(JSONObject jSONObject) {
        ...
        try {
            ...
            objM3603constructorimpl = Result.m3603constructorimpl(aFi1xSDK);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th));
        }
        return (AFi1xSDK) (Result.m3609isFailureimpl(objM3603constructorimpl) ? null : objM3603constructorimpl);
    }
