...
public final /* data */ class dg {
    ...
    public static final class a {
        ...
        private final Result<WebView> a(String adViewId) {
            ...
            if (presentingView == null) {
                ...
                objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(new Exception("missing adview for id: '" + adViewId + '\'')));
            } else {
                Result.Companion companion2 = Result.INSTANCE;
                objM3603constructorimpl = Result.m3603constructorimpl(presentingView);
            }
        ...
        private final Result<Drawable> b(String iconUrl) {
            ...
            return Result.m3602boximpl(this.imageLoader.a(iconUrl));
        }
    ...
    public static final class b {
        ...
        public static final /* data */ class a {
            ...
            public final dg h() {
                ...
                if (result != null) {
                    ...
                    if (Result.m3609isFailureimpl(value)) {
                        value = null;
                    }
                ...
                if (result2 != null) {
                    ...
                    webView = (WebView) (Result.m3609isFailureimpl(value2) ? null : value2);
                }
            ...
            public int hashCode() {
                ...
                Result<Drawable> result = this.icon;
                int iM3608hashCodeimpl = (iHashCode4 + (result == null ? 0 : Result.m3608hashCodeimpl(result.getValue()))) * 31;
                Result<WebView> result2 = this.media;
                return ((iM3608hashCodeimpl + (result2 != null ? Result.m3608hashCodeimpl(result2.getValue()) : 0)) * 31) + this.privacyIcon.hashCode();
            }
        ...
        private static final <T> void a(JSONObject jSONObject, String str, Object obj) throws JSONException {
            ...
            jSONObject2.put("success", Result.m3610isSuccessimpl(obj));
