...
public final class VungleBannerView extends RelativeLayout {
        ...
        if (!this.presenterStarted.getAndSet(true)) {
            ...
            getImpressionTracker().addView(this, new ImpressionTracker.ImpressionListener() { // from class: com.vungle.ads.VungleBannerView$$ExternalSyntheticLambda0
                ...
                public final void onImpression(View view) throws Throwable {
                    VungleBannerView.m3403renderAd$lambda1(this.f$0, view);
                }
            });
        }
    ...
    public static final void m3403renderAd$lambda1(VungleBannerView this$0, View view) throws Throwable {
    ...
    private final void willPresentAdView(AdPayload advertisement, Placement placement, VungleAdSize fixedAdSize) throws InstantiationException {
        ...
        try {
            ...
            OMTracker oMTrackerMake = m3405willPresentAdView$lambda4(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<OMTracker.Factory>() { // from class: com.vungle.ads.VungleBannerView$willPresentAdView$$inlined$inject$2
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            VungleWebClient vungleWebClient = new VungleWebClient(advertisement, placement, m3404willPresentAdView$lambda3(lazy).getOFFLOAD_EXECUTOR(), null, m3406willPresentAdView$lambda5(lazy2), 8, null);
            this.ringerModeReceiver.setWebClient(vungleWebClient);
            vungleWebClient.setWebViewObserver(oMTrackerMake);
            MRAIDPresenter mRAIDPresenter = new MRAIDPresenter(mRAIDAdWidget, advertisement, placement, vungleWebClient, m3404willPresentAdView$lambda3(lazy).getJOB_EXECUTOR(), oMTrackerMake, this.adViewImpl.getAdInternal$vungle_ads_release().getBidPayload(), m3406willPresentAdView$lambda5(lazy2));
    ...
    private static final Executors m3404willPresentAdView$lambda3(Lazy<? extends Executors> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: willPresentAdView$lambda-4, reason: not valid java name */
    private static final OMTracker.Factory m3405willPresentAdView$lambda4(Lazy<OMTracker.Factory> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: willPresentAdView$lambda-5, reason: not valid java name */
    private static final Platform m3406willPresentAdView$lambda5(Lazy<? extends Platform> lazy) {
        return lazy.getValue();
    }
}
