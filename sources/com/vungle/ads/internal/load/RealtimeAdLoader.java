...
public final class RealtimeAdLoader extends BaseAdLoader {
        ...
        if (ConfigManager.INSTANCE.rtaDebuggingEnabled()) {
            try {
                ...
                if (decodedAdsResponse != null) {
                    new RTADebugger(m3466requestAd$lambda0(lazy)).reportAdMarkup(decodedAdsResponse);
                }
    ...
    private static final VungleApiClient m3466requestAd$lambda0(Lazy<VungleApiClient> lazy) {
    ...
    private final void sendWinNotification(List<String> notifications) {
        if (notifications == null || !notifications.isEmpty()) {
            ...
            TpatSender tpatSender = new TpatSender(vungleApiClient, referenceId, creativeId, advertisement$vungle_ads_release2 != null ? advertisement$vungle_ads_release2.eventId() : null, getSdkExecutors().getIO_EXECUTOR(), getPathProvider(), m3467sendWinNotification$lambda2(lazy));
    ...
    private static final SignalManager m3467sendWinNotification$lambda2(Lazy<SignalManager> lazy) {
        return lazy.getValue();
    }
}
