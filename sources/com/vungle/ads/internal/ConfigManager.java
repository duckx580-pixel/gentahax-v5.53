...
public final class ConfigManager {
    ...
    private static final VungleApiClient m3424fetchConfigAsync$lambda0(Lazy<VungleApiClient> lazy) {
    ...
    public final void fetchConfigAsync$vungle_ads_release(final Context context, final Function1<? super Boolean, Unit> onComplete) {
        ...
        try {
            ...
            Call<ConfigPayload> callConfig = m3424fetchConfigAsync$lambda0(lazy).config();
            if (callConfig != null) {
    ...
    public final void updateConfigExtension$vungle_ads_release(final Context context, String ext) {
        ...
        configExt = ext;
        ServiceLocator.Companion companion = ServiceLocator.INSTANCE;
        m3427updateConfigExtension$lambda1(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<FilePreferences>() { // from class: com.vungle.ads.internal.ConfigManager$updateConfigExtension$$inlined$inject$1
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    private static final FilePreferences m3427updateConfigExtension$lambda1(Lazy<FilePreferences> lazy) {
        return lazy.getValue();
    }
    ...
    private static final FilePreferences m3425initWithConfig$lambda2(Lazy<FilePreferences> lazy) {
        return lazy.getValue();
    }
    ...
    public final synchronized void initWithConfig$vungle_ads_release(final Context context, ConfigPayload config2, boolean fromCachedConfig, SingleValueMetric metric) {
        ...
        try {
            ...
            if (iCheckConfigPayload$vungle_ads_release == 1) {
                if (!fromCachedConfig && config2 != null) {
                    ...
                    if (configPayload2 != null) {
                        INSTANCE.updateCachedConfig(configPayload2, m3425initWithConfig$lambda2(lazy));
                    }
                }
                return;
            }
            ...
            if (!fromCachedConfig && config2 != null) {
                updateCachedConfig(config2, m3425initWithConfig$lambda2(lazy));
            ...
            if (omEnabled()) {
                ...
                m3426initWithConfig$lambda5(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<OMInjector>() { // from class: com.vungle.ads.internal.ConfigManager$initWithConfig$$inlined$inject$2
                    /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                    {
                        super(0);
                    }
    ...
    private static final OMInjector m3426initWithConfig$lambda5(Lazy<OMInjector> lazy) {
        return lazy.getValue();
    }
