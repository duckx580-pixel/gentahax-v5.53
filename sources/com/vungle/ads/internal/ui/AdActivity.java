...
public abstract class AdActivity extends Activity {
    ...
    /* JADX WARN: Type inference failed for: r1v8, types: [java.lang.String, kotlin.jvm.internal.DefaultConstructorMarker] */
    ...
    protected void onCreate(Bundle savedInstanceState) throws Throwable {
        ...
        try {
            ...
            if (unclosedAd != null) {
                m3505onCreate$lambda2(lazy).recordUnclosedAd(unclosedAd);
            }
            mRAIDAdWidget.setCloseDelegate(new MRAIDAdWidget.CloseDelegate() { // from class: com.vungle.ads.internal.ui.AdActivity$onCreate$5$1
                ...
                public void close() {
                    ...
                    if (unclosedAd2 != null) {
                        AdActivity.m3505onCreate$lambda2(lazy).removeUnclosedAd(unclosedAd2);
                    }
                    this.this$0.finish();
                }
            });
            ...
            VungleWebClient vungleWebClient = new VungleWebClient(adPayload, placement, m3506onCreate$lambda6(lazy2).getOFFLOAD_EXECUTOR(), m3505onCreate$lambda2(lazy), m3507onCreate$lambda7(lazy3));
            ServiceLocator.Companion companion5 = ServiceLocator.INSTANCE;
            OMTracker oMTrackerMake = m3508onCreate$lambda8(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<OMTracker.Factory>() { // from class: com.vungle.ads.internal.ui.AdActivity$onCreate$$inlined$inject$4
                /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
                {
                    super(0);
                }
            ...
            VungleThreadPoolExecutor job_executor = m3506onCreate$lambda6(lazy2).getJOB_EXECUTOR();
            vungleWebClient.setWebViewObserver(oMTrackerMake);
            this.ringerModeReceiver.setWebClient(vungleWebClient);
            MRAIDPresenter mRAIDPresenter = new MRAIDPresenter(mRAIDAdWidget, adPayload, placement, vungleWebClient, job_executor, oMTrackerMake, bidPayload, m3507onCreate$lambda7(lazy3));
    ...
    public static final SignalManager m3505onCreate$lambda2(Lazy<SignalManager> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: onCreate$lambda-6, reason: not valid java name */
    private static final Executors m3506onCreate$lambda6(Lazy<? extends Executors> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: onCreate$lambda-7, reason: not valid java name */
    private static final Platform m3507onCreate$lambda7(Lazy<? extends Platform> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: onCreate$lambda-8, reason: not valid java name */
    private static final OMTracker.Factory m3508onCreate$lambda8(Lazy<OMTracker.Factory> lazy) {
        return lazy.getValue();
    }
