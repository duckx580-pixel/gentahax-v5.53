...
public final class VungleWebClient extends WebViewClient implements WebViewAPI {
                    ...
                    if (mraidDelegate != null) {
                        ...
                        this.offloadExecutor.submit(new Runnable() { // from class: com.vungle.ads.internal.ui.VungleWebClient$$ExternalSyntheticLambda1
                            ...
                            public final void run() {
                                VungleWebClient.m3510shouldOverrideUrlLoading$lambda4$lambda3$lambda2(mraidDelegate, host, jsonObjectBuild, handler, this, view);
                            }
                        });
                    }
                    return true;
    ...
    public static final void m3510shouldOverrideUrlLoading$lambda4$lambda3$lambda2(WebViewAPI.MraidDelegate it, String command, JsonObject args, Handler handler, final VungleWebClient this$0, final WebView webView) {
        ...
        if (it.processCommand(command, args)) {
            handler.post(new Runnable() { // from class: com.vungle.ads.internal.ui.VungleWebClient$$ExternalSyntheticLambda0
                ...
                public final void run() throws Throwable {
                    VungleWebClient.m3511shouldOverrideUrlLoading$lambda4$lambda3$lambda2$lambda1(this.f$0, webView);
                }
            });
        }
    }
    ...
    public static final void m3511shouldOverrideUrlLoading$lambda4$lambda3$lambda2$lambda1(VungleWebClient this$0, WebView webView) throws Throwable {
        Intrinsics.checkNotNullParameter(this$0, "this$0");
