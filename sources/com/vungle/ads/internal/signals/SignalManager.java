...
public final class SignalManager {
    ...
    public SignalManager(final Context context) {
        ...
        UnclosedAdDetector unclosedAdDetector = new UnclosedAdDetector(context, this.currentSession.getSessionId(), m3499_init_$lambda0(lazy), m3500_init_$lambda1(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<PathProvider>() { // from class: com.vungle.ads.internal.signals.SignalManager$special$$inlined$inject$3
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    private static final Executors m3499_init_$lambda0(Lazy<? extends Executors> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: _init_$lambda-1, reason: not valid java name */
    private static final PathProvider m3500_init_$lambda1(Lazy<PathProvider> lazy) {
        return lazy.getValue();
    }
        ...
        ActivityManager.INSTANCE.addLifecycleListener(new ActivityManager.LifeCycleCallback() { // from class: com.vungle.ads.internal.signals.SignalManager.registerNotifications.1
            ...
            public void onResume() {
                ...
                if (SignalManager.this.getEnterBackgroundTime() == 0) {
                    Logger.INSTANCE.d(SignalManager.TAG, "SignalManager#onResume skipped");
                    return;
                }
                long jCurrentTimeMillis = System.currentTimeMillis();
