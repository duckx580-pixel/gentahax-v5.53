...
public final class ClickCoordinateTracker {
    ...
    private final void sendClickCoordinates() throws Throwable {
        ...
        TpatSender tpatSender = new TpatSender(getVungleApiClient(), this.advertisement.placementId(), this.advertisement.getCreativeId(), this.advertisement.eventId(), getExecutors().getIO_EXECUTOR(), m3422sendClickCoordinates$lambda0(lazy), m3423sendClickCoordinates$lambda1(LazyKt.lazy(LazyThreadSafetyMode.SYNCHRONIZED, (Function0) new Function0<SignalManager>() { // from class: com.vungle.ads.internal.ClickCoordinateTracker$sendClickCoordinates$$inlined$inject$2
            /* JADX WARN: 'super' call moved to the top of the method (can break code semantics) */
            {
                super(0);
            }
    ...
    private static final PathProvider m3422sendClickCoordinates$lambda0(Lazy<PathProvider> lazy) {
        return lazy.getValue();
    }

    /* JADX INFO: renamed from: sendClickCoordinates$lambda-1, reason: not valid java name */
    private static final SignalManager m3423sendClickCoordinates$lambda1(Lazy<SignalManager> lazy) {
        return lazy.getValue();
    }
