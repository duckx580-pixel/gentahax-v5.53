...
public final class ResendTpatJob implements Job {
    ...
    private static final VungleApiClient m3502onRunJob$lambda0(Lazy<VungleApiClient> lazy) {
    ...
    public int onRunJob(Bundle bundle, JobRunner jobRunner) {
        ...
        new TpatSender(m3502onRunJob$lambda0(lazy), null, null, null, m3503onRunJob$lambda1(lazy2).getIO_EXECUTOR(), this.pathProvider, null, 64, null).resendStoredTpats$vungle_ads_release(m3503onRunJob$lambda1(lazy2).getJOB_EXECUTOR());
        return 0;
    }

    /* JADX INFO: renamed from: onRunJob$lambda-1, reason: not valid java name */
    private static final Executors m3503onRunJob$lambda1(Lazy<? extends Executors> lazy) {
        return lazy.getValue();
    }
