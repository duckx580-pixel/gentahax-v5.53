...
public final class CleanupJob implements Job {
    ...
    private final void checkIfSdkUpgraded() {
        ...
        int i = m3501checkIfSdkUpgraded$lambda3(lazy).getInt("VERSION_CODE", -1);
        if (i < 70401) {
            if (i < 70000) {
                dropV6Data();
            }
            ...
            m3501checkIfSdkUpgraded$lambda3(lazy).put("VERSION_CODE", BuildConfig.VERSION_CODE).apply();
        }
    }

    /* JADX INFO: renamed from: checkIfSdkUpgraded$lambda-3, reason: not valid java name */
    private static final FilePreferences m3501checkIfSdkUpgraded$lambda3(Lazy<FilePreferences> lazy) {
