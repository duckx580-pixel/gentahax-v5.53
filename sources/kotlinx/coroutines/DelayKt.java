...
public final class DelayKt {
    ...
    */
    ...
    public static final Object delay(long j, Continuation<? super Unit> continuation) {
        ...
        if (j < Long.MAX_VALUE) {
            getDelay(cancellableContinuationImpl2.getContext()).mo5162scheduleResumeAfterDelay(j, cancellableContinuationImpl2);
        }
    ...
    public static final Object m5093delayVtjQ1oo(long j, Continuation<? super Unit> continuation) {
        Object objDelay = delay(m5094toDelayMillisLRDsOJo(j), continuation);
    ...
    public static final long m5094toDelayMillisLRDsOJo(long j) {
        if (Duration.m4928compareToLRDsOJo(j, Duration.INSTANCE.m5032getZEROUwyO8pc()) > 0) {
            return RangesKt.coerceAtLeast(Duration.m4947getInWholeMillisecondsimpl(j), 1L);
        }
        return 0L;
    }
}
