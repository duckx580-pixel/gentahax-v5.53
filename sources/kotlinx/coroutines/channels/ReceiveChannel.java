...
public interface ReceiveChannel<E> {
    ...
    Object mo5109receiveCatchingJP2dKIU(Continuation<? super ChannelResult<? extends E>> continuation);
    ...
    Object mo5110tryReceivePtdJZtk();
    ...
    public static final class DefaultImpls {
        ...
        public static <E> E poll(ReceiveChannel<? extends E> receiveChannel) throws Throwable {
            Object objMo5110tryReceivePtdJZtk = receiveChannel.mo5110tryReceivePtdJZtk();
            if (ChannelResult.m5125isSuccessimpl(objMo5110tryReceivePtdJZtk)) {
                return (E) ChannelResult.m5121getOrThrowimpl(objMo5110tryReceivePtdJZtk);
            }
            Throwable thM5119exceptionOrNullimpl = ChannelResult.m5119exceptionOrNullimpl(objMo5110tryReceivePtdJZtk);
            if (thM5119exceptionOrNullimpl == null) {
                return null;
            }
            throw StackTraceRecoveryKt.recoverStackTrace(thM5119exceptionOrNullimpl);
        }
        ...
        */
        public static <E> java.lang.Object receiveOrNull(kotlinx.coroutines.channels.ReceiveChannel<? extends E> r4, kotlin.coroutines.Continuation<? super E> r5) {
            ...
            L38:
                kotlin.ResultKt.throwOnFailure(r5)
                r0.label = r3
                java.lang.Object r4 = r4.mo5109receiveCatchingJP2dKIU(r0)
                if (r4 != r1) goto L44
                return r1
            L44:
                java.lang.Object r4 = kotlinx.coroutines.channels.ChannelResult.m5120getOrNullimpl(r4)
                return r4
            */
