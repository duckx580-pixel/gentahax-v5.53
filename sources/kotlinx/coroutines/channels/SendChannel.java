...
public interface SendChannel<E> {
    ...
    Object mo5105trySendJP2dKIU(E element);
    ...
    public static final class DefaultImpls {
        ...
        public static <E> boolean offer(SendChannel<? super E> sendChannel, E e) throws Throwable {
            ...
            if (ChannelResult.m5125isSuccessimpl(objMo5105trySendJP2dKIU)) {
                return true;
            }
            Throwable thM5119exceptionOrNullimpl = ChannelResult.m5119exceptionOrNullimpl(objMo5105trySendJP2dKIU);
