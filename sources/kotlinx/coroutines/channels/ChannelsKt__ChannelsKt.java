...
final /* synthetic */ class ChannelsKt__ChannelsKt {
    ...
    static final class AnonymousClass2 extends SuspendLambda implements Function2<CoroutineScope, Continuation<? super ChannelResult<? extends Unit>>, Object> {
        ...
        public final Object invokeSuspend(Object obj) {
            ...
            return ChannelResult.m5115boximpl(Result.m3610isSuccessimpl(objM3603constructorimpl) ? ChannelResult.INSTANCE.m5130successJP2dKIU(Unit.INSTANCE) : ChannelResult.INSTANCE.m5128closedJP2dKIU(Result.m3606exceptionOrNullimpl(objM3603constructorimpl)));
        }
    }

    /* JADX WARN: Multi-variable type inference failed */
    public static final <E> Object trySendBlocking(SendChannel<? super E> sendChannel, E e) {
        Object objMo5105trySendJP2dKIU = sendChannel.mo5105trySendJP2dKIU(e);
    ...
    public static final /* synthetic */ void sendBlocking(SendChannel sendChannel, Object obj) throws InterruptedException {
        if (ChannelResult.m5125isSuccessimpl(sendChannel.mo5105trySendJP2dKIU(obj))) {
            return;
        }
