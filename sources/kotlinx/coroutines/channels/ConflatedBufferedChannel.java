...
public class ConflatedBufferedChannel<E> extends BufferedChannel<E> {
    ...
    static /* synthetic */ <E> Object send$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Unit> continuation) throws Throwable {
        ...
        Object objM5133trySendImplMj0NB7M = conflatedBufferedChannel.m5133trySendImplMj0NB7M(e, true);
        if (objM5133trySendImplMj0NB7M instanceof ChannelResult.Closed) {
            ChannelResult.m5119exceptionOrNullimpl(objM5133trySendImplMj0NB7M);
    ...
    static /* synthetic */ <E> Object sendBroadcast$suspendImpl(ConflatedBufferedChannel<E> conflatedBufferedChannel, E e, Continuation<? super Boolean> continuation) {
        Object objM5133trySendImplMj0NB7M = conflatedBufferedChannel.m5133trySendImplMj0NB7M(e, true);
        if (!(objM5133trySendImplMj0NB7M instanceof ChannelResult.Failed)) {
    ...
    public Object mo5105trySendJP2dKIU(E element) {
        return m5133trySendImplMj0NB7M(element, false);
    }

    /* JADX INFO: renamed from: trySendImpl-Mj0NB7M, reason: not valid java name */
    private final Object m5133trySendImplMj0NB7M(E element, boolean isSendOp) {
        return this.onBufferOverflow == BufferOverflow.DROP_LATEST ? m5131trySendDropLatestMj0NB7M(element, isSendOp) : m5132trySendDropOldestJP2dKIU(element);
    }

    /* JADX INFO: renamed from: trySendDropLatest-Mj0NB7M, reason: not valid java name */
    private final Object m5131trySendDropLatestMj0NB7M(E element, boolean isSendOp) {
        Function1<E, Unit> function1;
        UndeliveredElementException undeliveredElementExceptionCallUndeliveredElementCatchingException$default;
        Object objMo5105trySendJP2dKIU = super.mo5105trySendJP2dKIU(element);
        if (ChannelResult.m5125isSuccessimpl(objMo5105trySendJP2dKIU) || ChannelResult.m5123isClosedimpl(objMo5105trySendJP2dKIU)) {
            return objMo5105trySendJP2dKIU;
        }
    ...
    private final Object m5132trySendDropOldestJP2dKIU(E element) {
    ...
    protected void registerSelectForSend(SelectInstance<?> select, Object element) {
        Object objMo5105trySendJP2dKIU = mo5105trySendJP2dKIU(element);
        if (!(objMo5105trySendJP2dKIU instanceof ChannelResult.Failed)) {
            select.selectInRegistrationPhase(Unit.INSTANCE);
        } else {
            if (!(objMo5105trySendJP2dKIU instanceof ChannelResult.Closed)) {
                throw new IllegalStateException("unreachable".toString());
            }
            ChannelResult.m5119exceptionOrNullimpl(objMo5105trySendJP2dKIU);
