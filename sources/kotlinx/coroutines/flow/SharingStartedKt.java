...
public final class SharingStartedKt {
    ...
    public static /* synthetic */ SharingStarted m5148WhileSubscribed5qebJ5I$default(SharingStarted.Companion companion, long j, long j2, int i, Object obj) {
        if ((i & 1) != 0) {
            j = Duration.INSTANCE.m5032getZEROUwyO8pc();
        }
        if ((i & 2) != 0) {
            j2 = Duration.INSTANCE.m5030getINFINITEUwyO8pc();
        }
        return m5147WhileSubscribed5qebJ5I(companion, j, j2);
    }

    /* JADX INFO: renamed from: WhileSubscribed-5qebJ5I, reason: not valid java name */
    public static final SharingStarted m5147WhileSubscribed5qebJ5I(SharingStarted.Companion companion, long j, long j2) {
        return new StartedWhileSubscribed(Duration.m4947getInWholeMillisecondsimpl(j), Duration.m4947getInWholeMillisecondsimpl(j2));
    }
}
