...
final /* synthetic */ class FlowKt__ErrorsKt {
    ...
    static final class C18761 extends SuspendLambda implements Function2<Throwable, Continuation<? super Boolean>, Object> {
        int label;
        ...
        public final Continuation<Unit> create(Object obj, Continuation<?> continuation) {
            return new C18761(continuation);
        }

        @Override // kotlin.jvm.functions.Function2
        public final Object invoke(Throwable th, Continuation<? super Boolean> continuation) {
            return ((C18761) create(th, continuation)).invokeSuspend(Unit.INSTANCE);
        }
