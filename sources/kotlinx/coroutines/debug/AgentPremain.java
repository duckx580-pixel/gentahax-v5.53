...
public final class AgentPremain {
    ...
    static {
        ...
        try {
            ...
            objM3603constructorimpl = Result.m3603constructorimpl(property != null ? Boolean.valueOf(Boolean.parseBoolean(property)) : null);
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th));
        }
        Boolean bool = (Boolean) (Result.m3609isFailureimpl(objM3603constructorimpl) ? null : objM3603constructorimpl);
