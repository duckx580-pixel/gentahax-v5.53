...
public final class StackTraceRecoveryKt {
    ...
    static {
        ...
        try {
            ...
            objM3603constructorimpl = Result.m3603constructorimpl(Class.forName(baseContinuationImplClass).getCanonicalName());
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th));
        }
        if (Result.m3606exceptionOrNullimpl(objM3603constructorimpl) == null) {
            obj2 = objM3603constructorimpl;
        }
        baseContinuationImplClassName = (String) obj2;
        try {
            Result.Companion companion3 = Result.INSTANCE;
            objM3603constructorimpl2 = Result.m3603constructorimpl(Class.forName(stackTraceRecoveryClass).getCanonicalName());
        } catch (Throwable th2) {
            Result.Companion companion4 = Result.INSTANCE;
            objM3603constructorimpl2 = Result.m3603constructorimpl(ResultKt.createFailure(th2));
        }
        if (Result.m3606exceptionOrNullimpl(objM3603constructorimpl2) == null) {
            obj = objM3603constructorimpl2;
        }
