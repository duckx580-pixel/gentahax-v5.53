...
public final class ExceptionsConstructorKt {
    ...
    public static final <E extends Throwable> E tryCopyException(E e) {
        ...
        if (e instanceof CopyableThrowable) {
            try {
                ...
                objM3603constructorimpl = Result.m3603constructorimpl(((CopyableThrowable) e).createCopy());
            } catch (Throwable th) {
            ...
            return (E) objM3603constructorimpl;
        }
        ...
        return new Function1<Throwable, Throwable>() { // from class: kotlinx.coroutines.internal.ExceptionsConstructorKt.safeCtor.1
            ...
            public final Throwable invoke(Throwable th) {
                ...
                try {
                    ...
                    objM3603constructorimpl = Result.m3603constructorimpl(thInvoke);
                } catch (Throwable th2) {
                    Result.Companion companion2 = Result.INSTANCE;
                    objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th2));
                }
                return (Throwable) (Result.m3609isFailureimpl(objM3603constructorimpl) ? null : objM3603constructorimpl);
            }
        };
    }
    ...
    private static final int fieldsCountOrDefault(Class<?> cls, int i) {
        ...
        try {
            Result.Companion companion = Result.INSTANCE;
            objM3603constructorimpl = Result.m3603constructorimpl(Integer.valueOf(fieldsCount$default(cls, 0, 1, null)));
        } catch (Throwable th) {
            Result.Companion companion2 = Result.INSTANCE;
            objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th));
        }
        ...
        if (Result.m3609isFailureimpl(objM3603constructorimpl)) {
            objM3603constructorimpl = numValueOf;
        }
        return ((Number) objM3603constructorimpl).intValue();
    }
