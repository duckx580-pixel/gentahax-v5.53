...
public final class ComposerForUnsignedNumbers extends Composer {
    ...
    public void print(int v) {
        ...
        String unsignedString = Integer.toUnsignedString(UInt.m3698constructorimpl(v));
        if (z) {
    ...
    public void print(long v) {
        boolean z = this.forceQuoting;
        String unsignedString = Long.toUnsignedString(ULong.m3777constructorimpl(v));
        if (z) {
            printQuoted(unsignedString);
        } else {
            print(unsignedString);
    ...
    public void print(byte v) {
        boolean z = this.forceQuoting;
        String strM3665toStringimpl = UByte.m3665toStringimpl(UByte.m3621constructorimpl(v));
        if (z) {
            printQuoted(strM3665toStringimpl);
        } else {
            print(strM3665toStringimpl);
        }
    }
    ...
    public void print(short v) {
        boolean z = this.forceQuoting;
        String strM3928toStringimpl = UShort.m3928toStringimpl(UShort.m3884constructorimpl(v));
        if (z) {
            printQuoted(strM3928toStringimpl);
        } else {
            print(strM3928toStringimpl);
        }
    }
}
