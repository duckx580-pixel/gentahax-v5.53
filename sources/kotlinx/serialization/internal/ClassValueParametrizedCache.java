...
final class ClassValueParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo5174getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            ...
            Object objPutIfAbsent = concurrentHashMap.putIfAbsent(types, resultM3602boximpl);
