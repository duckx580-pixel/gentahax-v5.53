...
final class ParametrizedCacheEntry<T> {
    ...
    public final Object m5177computeIfAbsentgIAlus(List<? extends KType> types, Function0<? extends KSerializer<T>> producer) {
        ...
        if (obj == null) {
            try {
                ...
                objM3603constructorimpl = Result.m3603constructorimpl(producer.invoke());
            } catch (Throwable th) {
