...
final class ConcurrentHashMapParametrizedCache<T> implements ParametrizedSerializerCache<T> {
    ...
    public Object mo5174getgIAlus(KClass<Object> key, List<? extends KType> types) {
        ...
        if (obj == null) {
            try {
                ...
                objM3603constructorimpl = Result.m3603constructorimpl(this.compute.invoke(key, types));
            } catch (Throwable th) {
                Result.Companion companion2 = Result.INSTANCE;
                objM3603constructorimpl = Result.m3603constructorimpl(ResultKt.createFailure(th));
            }
            Result resultM3602boximpl = Result.m3602boximpl(objM3603constructorimpl);
            Object objPutIfAbsent = concurrentHashMap2.putIfAbsent(types, resultM3602boximpl);
            obj = objPutIfAbsent == null ? resultM3602boximpl : objPutIfAbsent;
        }
