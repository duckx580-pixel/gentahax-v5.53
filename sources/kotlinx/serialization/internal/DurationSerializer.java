...
public final class DurationSerializer implements KSerializer<Duration> {
    ...
    public /* bridge */ /* synthetic */ Object deserialize(Decoder decoder) {
        return Duration.m4927boximpl(m5175deserialize5sfh64U(decoder));
    }

    @Override // kotlinx.serialization.SerializationStrategy
    public /* bridge */ /* synthetic */ void serialize(Encoder encoder, Object obj) {
        m5176serializeHG0u8IE(encoder, ((Duration) obj).getRawValue());
    }
    ...
    public void m5176serializeHG0u8IE(Encoder encoder, long value) {
        Intrinsics.checkNotNullParameter(encoder, "encoder");
        encoder.encodeString(Duration.m4974toIsoStringimpl(value));
    }

    /* JADX INFO: renamed from: deserialize-5sfh64U, reason: not valid java name */
    public long m5175deserialize5sfh64U(Decoder decoder) {
        Intrinsics.checkNotNullParameter(decoder, "decoder");
        return Duration.INSTANCE.m5049parseIsoStringUwyO8pc(decoder.decodeString());
    }
}
