...
public final class CachingKt {
    ...
    static {
        ...
        try {
            ...
            objM3603constructorimpl = Result.m3603constructorimpl(Class.forName("java.lang.ClassValue"));
        } catch (Throwable th) {
        ...
        if (Result.m3610isSuccessimpl(objM3603constructorimpl)) {
            ...
            objM3603constructorimpl = true;
        }
        Object objM3603constructorimpl2 = Result.m3603constructorimpl(objM3603constructorimpl);
        if (Result.m3609isFailureimpl(objM3603constructorimpl2)) {
            objM3603constructorimpl2 = false;
        }
        useClassValue = ((Boolean) objM3603constructorimpl2).booleanValue();
    }
