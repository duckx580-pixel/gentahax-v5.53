...
public final class SimpleActor<T> {
        ...
        if (job != null) {
            job.invokeOnCompletion(new Function1<Throwable, Unit>() { // from class: androidx.datastore.core.SimpleActor.1
                ...
                public final void invoke2(Throwable th) {
                    ...
                    do {
                        Object objM5120getOrNullimpl = ChannelResult.m5120getOrNullimpl(((SimpleActor) this).messageQueue.mo5110tryReceivePtdJZtk());
                        if (objM5120getOrNullimpl != null) {
                            onUndeliveredElement.invoke((T) objM5120getOrNullimpl, th);
                            unit = Unit.INSTANCE;
                        } else {
                            unit = null;
                        }
    ...
    public final void offer(T msg) {
        Object obj = this.messageQueue.mo5105trySendJP2dKIU(msg);
        if (obj instanceof ChannelResult.Closed) {
            Throwable thM5119exceptionOrNullimpl = ChannelResult.m5119exceptionOrNullimpl(obj);
            if (thM5119exceptionOrNullimpl != null) {
                throw thM5119exceptionOrNullimpl;
            }
            throw new ClosedSendChannelException("Channel was closed normally");
        }
        if (!ChannelResult.m5125isSuccessimpl(obj)) {
